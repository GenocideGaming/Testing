...
namespace Server.Misc
{
    public class ServerList
    {
        ...
        public static string Address = "144.48.106.219";        // Server Address Goes Here
        public static string AddressA = "144.48.106.219";
...
namespace Server.Network
{
    public class APH
    {
		...
		state.Send(new CharacterList(state.Account, state.CityInfo));					// For Runuo !!!
		//state.Send(new CharacterList(state.Account, state.CityInfo, state.IsEnhancedClient));		// For Servuo !!!
