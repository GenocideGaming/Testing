...
namespace Server.Mobiles
{
	...
	public class EncagedGiantSerpent : BaseCreature
	{
		[Constructable]
		public EncagedGiantSerpent() : base( AIType.AI_Generic, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an encaged giant serpent";
			Body = 0x15;
        ...
        public EncagedGiantSerpent(Serial serial)
            : base(serial)
		{
		}
