...
namespace Server.Mobiles
{
    ...
    public class LockmoorArcher : BaseCreature
    {
        [Constructable]
        public LockmoorArcher()
            : base(AIType.AI_Generic, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            SpeechHue = Utility.RandomDyedHue();
            Name = "Lockmoor Archer";
            Hue = 1882;
        ...
        public override void GenerateLoot()
        {
            ...
            base.PackAddBandageTier(3);
            base.PackAddArrowTier(2);
        }

        public override bool AlwaysMurderer { get { return true; } }

        public LockmoorArcher(Serial serial)
            : base(serial)
        {
        }
