...
namespace Server.Mobiles
{
	public class SanguinProtector : BaseCreature
	{
        ...
        public override bool OnBeforeDeath()
        {
            ...
            //Final Loot
            rm.PackAddGoldTier(11);
            rm.PackAddArtifactChanceTier(11);
            rm.PackAddMapChanceTier(11);

            rm.PackAddScrollTier(8);
            rm.PackAddReagentTier(4);

            rm.PackAddArtifactChanceTier(9);
