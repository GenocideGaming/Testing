...
namespace Server.Scripts.Custom.BountySystem
{
    ...
    class TemporaryStatloss
    {
        ...
        // killer's head must be turned into the bounty hunter officer for statloss checks to occur
        ...
        /* public static void EventSink_PlayerDeath(PlayerDeathEventArgs e)
        {
            ...
            if (slain == null || slayer == null || (slain.TeamFlags > 1 && slayer.TeamFlags > 1)) // make sure they aren't in some kind of team event
                return;

            if(slayer.BountyHunter)
                return;
