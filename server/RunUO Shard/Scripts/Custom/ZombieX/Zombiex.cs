...
namespace Server.Mobiles
{
    ...
    public class Zombiex : BaseUndead
    {
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            if (m is Zombiex && Combatant != null)
            {
                if (m.Combatant == null)
                {
                    m.Combatant = Combatant;
                    m.Say("*Urrghh*");  // what does the zombie getting called say
                    Say("*Graaaghhrr*"); // what does the zombie doing the calling say
                }
            }
        ...
        public virtual void NewZombie(Mobile from)
        {
            ...
            else
            {
                ...
                Female = from.Female;
                if (from.Body == 400 || from.Body == 401)
                {
                    Body = 155;
                }
                else
