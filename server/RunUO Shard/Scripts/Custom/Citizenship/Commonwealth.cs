...
namespace Server.Scripts.Custom.Citizenship
{
    ...
    [CustomEnum(new string[] { "Trinsic Commonwealth", "Yew Commonwealth", "Blackrock Commonwealth"})]
        ...
        public static void OnCommand_ResetHeroes(CommandEventArgs e)
        {
            foreach (Commonwealth township in Commonwealth.Commonwealths)
            {
                ...
                else
                {
                    ...
                    {
                        e.Mobile.SendMessage("Having to recreate a town hero for " + township.Definition.TownName);
