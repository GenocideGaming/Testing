...
namespace Server.Scripts
{
    ...
    {        
        ...
        // See story 41
        // Adds the ability for mages to stun punch people.
        public static class StunPunch
        {
            ...
            public static readonly double AnatomySkillNeeded = 80.0;
            ...
            public static SkillName[] SkillsRequiredToAttempt = { SkillName.Wrestling, SkillName.Anatomy };
            public static double MinimumSkillRequired = 80;
            public static readonly string NotEnoughSkillText = "You lack the skill to attempt a stunning blow.";
            public static readonly double MaxChance = 0.75; // 50%
        }
        ...
        public static class ScribeMage
        {
            ...
            // Magic Reflect
            public static readonly int MinimumCirclesToReflect = 1;      // Circles absorbed at 0% Scribe/Magery
            public static readonly int MaximumCirclesToReflect = 8;     // Circles absorbed at GM Scribe/Magery
            ...
            // Reactive Armor
            public static readonly int MinimumArmorBoost = 20;           // % damage absorb bonus at 0% Scribe/Magery
            public static readonly int MaximumArmorBoost = 80;          // % damage absorb bonus at GM Scribe/Magery
            ...
            // Protection
            public static readonly int MinimumInterruptResistChance = 0;           // at 0% Scribe/Magery
            public static readonly int MaximumInterruptResistChance = 85;          // at GM Scribe/Magery
        ...
        public static class Militias
        {
            ...
            public static readonly string ForsakenAboutText = "Forsaken, followers of Haliax.";
            public static readonly string PaladinOrderAboutText = "Paladin Order, followers of Dupree.";
            public static readonly string UrukhaiAboutText = "Uruk-hai, followers of Gojira.";
            
            public static readonly float YieldSilverBlockTimeInMinutes = 30; //the time after dying and giving silver before the player yields silver again

            public static readonly float SkillLossTimeInMinutes = 5;

            //Forsaken
            public static readonly string DLTier0TitleText = "Minion";
            public static readonly string DLTier1TitleText = "Apostate";
            public static readonly string DLTier2TitleText = "Heretic";
            public static readonly string DLTier3TitleText = "Zealot";
            public static readonly string DLTier4TitleText = "Chandrian";
            public static readonly string DLTier5TitleText = "Death Knight"; //the rank given to the player with the highest points
               
            //Paladin Order
            public static readonly string POTier0TitleText = "Paige";
            public static readonly string POTier1TitleText = "Squire";
            public static readonly string POTier2TitleText = "Knight";
            public static readonly string POTier3TitleText = "Crusader";
            public static readonly string POTier4TitleText = "Amyr";
            public static readonly string POTier5TitleText = "Holy Knight"; //the rank given to the player with the highest points

            //Uruk-hai
            public static readonly string UHTier0TitleText = "Peon";
            public static readonly string UHTier1TitleText = "Grunt";
            public static readonly string UHTier2TitleText = "Raider";
            public static readonly string UHTier3TitleText = "Captain";
            public static readonly string UHTier4TitleText = "Warlord";
            public static readonly string UHTier5TitleText = "Chieftain"; //the rank given to the player with the highest points
        ...
        public static class SkillChanges
        {
            ...
            public static readonly double DungeonSkillGainChanceIncrease = 1.25; // Dungeon skill gain bonus
            ...
            public static readonly double TownFactor = 0.5;
            public static readonly double HouseFactor = 0.5;
        ...
        public static class DisarmingMove
        {
            ...
            public static readonly double WrestlingSkillNeeded = 80.0;
            public static readonly double TacticsSkillNeeded = 80.0;
        ...
        public static class SpellChanges
        {
            ...
            public static readonly int WallOfStoneRecastDelay = 15;     // seconds
        ...
        public static int CharactersPerAccount = 1;
    }
}
