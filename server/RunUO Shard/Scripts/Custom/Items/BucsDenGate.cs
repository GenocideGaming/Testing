...
namespace Server.Items
{
    public class BucsDenGate : Moongate
    {
        ...
        [Constructable]
        public BucsDenGate(bool decays, Point3D loc, Map map)
            : this(decays)
        {
        ...
        [Constructable]
        public BucsDenGate(bool decays)
            : base(new Point3D(2729, 2133, 0), Map.Felucca)
        {
        ...
        public BucsDenGate(Serial serial)
            : base(serial)
        {
        }
