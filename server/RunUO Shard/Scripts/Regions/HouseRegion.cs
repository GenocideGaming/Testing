...
namespace Server.Regions
{
	...
	{
		public static readonly int HousePriority = Region.DefaultPriority + 10;
		...
		{
			return true; //m_House.CheckAccessibility( item, from );
		}
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			if( (m_House is Tower || m_House is TowerE) && !m_House.IsInside( from ))
				return;
