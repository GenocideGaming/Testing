...
{
	public class GenTeleporterAtria
	{
		public GenTeleporterAtria()
		{
		}

		public static void Initialize()
		{
			CommandSystem.Register( "TelGenAtria", AccessLevel.Administrator, new CommandEventHandler( GenTeleporter_OnCommand ) );
		}
		...
		public static void GenTeleporter_OnCommand( CommandEventArgs e )
		{
            ...
            // use a cfg file rather than hard coded locations!
            Decorate.Generate("Data/Teleporters", Map.Trammel);
		}
