...
namespace Server.Commands.Generic
{
	...
	public class IncreaseCommand : BaseCommand
	{
		...
		public override void Execute( CommandEventArgs e, object obj )
		{
			...
			{
				string result = EntityProperties.IncreaseValue( e.Mobile, obj, e.Arguments );
	...
	public class GetCommand : BaseCommand
	{
		...
		public override void Execute( CommandEventArgs e, object obj )
		{
			if ( e.Length >= 1 )
			{
				...
				{
					string result = EntityProperties.GetValue( e.Mobile, obj, e.GetString( i ) );
	...
	public class AliasedSetCommand : BaseCommand
	{
		...
		public override void Execute( CommandEventArgs e, object obj )
		{
			string result = EntityProperties.SetValue( e.Mobile, obj, m_Name, m_Value );
	...
	public class SetCommand : BaseCommand
	{
		...
		public override void Execute( CommandEventArgs e, object obj )
		{
			if ( e.Length >= 2 )
			{
				...
				{
					string result = EntityProperties.SetValue( e.Mobile, obj, e.GetString( i ), e.GetString( i+1 ) );
