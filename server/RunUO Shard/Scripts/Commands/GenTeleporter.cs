	...
	public class GenTeleporter
	{
		...
		public class TeleportersCreator
		{
			...
			public void CreateTeleportersMap(Map map)
			{
				...
				// Misc
				CreateTeleporter(5217, 18, 15, 5204, 74, 17, map, false); //Wind
				CreateTeleporter(5200, 71, 17, 5211, 22, 15, map, false);
				CreateTeleporter(1997, 81, 7, 5881, 242, 0, map, false); // Ice Dungeon Entrance
				CreateTeleporter(5705, 146, -45, 5705, 305, 7, map, false); // broken?
				CreateTeleporter(5705, 147, -45, 5705, 306, 7, map, false); // broken?
				CreateTeleporter(5874, 146, 27, 5732, 295, 0, map, true); //Ice Dungeon Passage to Ice Island
				CreateTeleporter(5875, 146, 27, 5733, 295, 0, map, true); 
                CreateTeleporter(5876, 146, 27, 5734, 295, 0, map, true); 
                CreateTeleporter(5877, 146, 27, 5735, 295, 0, map, true); //Ice Dungeon Passage to Ice Island
                CreateTeleporter(5746, 295, 0, 3918, 203, -8, map, true); //Ice Dungeon Passage to Ice Island
                CreateTeleporter(5747, 295, 0, 3919, 203, -8, map, true);
                CreateTeleporter(5748, 295, 0, 3920, 203, -8, map, true);
                CreateTeleporter(5749, 295, 0, 3921, 203, -8, map, true); //Ice Dungeon Passage to Ice Island
				CreateTeleporter(587, 1638, 0, 6574, 889, 0, map, true); //Blackrock
                CreateTeleporter(588, 1638, 0, 6575, 889, 0, map, true); //Blackrock
                CreateTeleporter(589, 1638, 0, 6576, 889, 0, map, true); //Blackrock
                CreateTeleporter(6589, 866, 0, 6488, 848, 39, map, true); //Blackrock
                CreateTeleporter(6589, 867, 0, 6488, 849, 40, map, true); //Blackrock
                CreateTeleporter(6589, 868, 0, 6488, 850, 40, map, true); //Blackrock
                CreateTeleporter(6589, 869, 0, 6488, 851, 39, map, true); //Blackrock
				//CreateTeleporter(2398, 198, 0, 5752, 436, 79, map, false);// T2A Passage Duel Pits
				//CreateTeleporter(2399, 198, 0, 5753, 436, 80, map, false);// T2A Passage Duel Pits
                DestroyTeleporter(5166, 245, 15, map); //Wind Inside
				DestroyTeleporter(1361, 883, 0, map); //Wind Outside
				CreateTeleporter(5191, 152, 0, 1367, 891, 0, map, false);
				CreateTeleporter(5849, 239, -25, 5831, 324, 27, map, false);//Ice Dungeon
				...
				CreateTeleporter(5853, 239, -23, 5835, 324, 27, map, false);//Ice Dungeon
				CreateTeleporter(5882, 241, 0, 1998, 81, 5, map, false);
				CreateTeleporter(5882, 242, 0, 1998, 81, 5, map, false);
				CreateTeleporter(5882, 243, 0, 1998, 81, 5, map, false);//Ice Exit
				CreateTeleporter(5706, 305, 12, 5705, 146, -45, map, false);
				CreateTeleporter(5706, 306, 12, 5705, 147, -45, map, false);
                //CreateTeleporter(5748, 362, 2, 313, 786, -24, map, false); //T2A Tunnel Exit
                //CreateTeleporter(5749, 362, 2, 313, 786, -24, map, false); //T2A Tunnel Exit
                //CreateTeleporter(5750, 362, 2, 314, 786, -24, map, false); //T2A Tunnel Exit
                //CreateTeleporter(5753, 324, 21, 5670, 2391, 40, map, false); //T2A Tunnel Exit
				...
				CreateTeleporter(5835, 323, 33, 5853, 238, -23, map, false); //Ice Dungeon
				//CreateTeleporter(5658, 423, 8, 5697, 3659, 2, map, false); //T2A Tunnel Exit
				...
				//CreateTeleporter(5752, 437, 78, 2400, 199, 0, map, false); 
				...
				//CreateTeleporter(312, 786, -24, 5748, 361, 2, map, false);
				//CreateTeleporter(313, 786, -24, 5749, 361, 2, map, false);
				//CreateTeleporter(2776, 895, -23, 5685, 387, 2, map, false); // GY T2A Teleport
				//CreateTeleporter( 4545, 851, 30, 5736, 3196, 8, map, false ); //Moonglow T2A Teleport
				DestroyTeleporter(4545, 851, 30, map);
				CreateTeleporter(4540, 898, 32, 4442, 1122, 5, map, false); //Moonglow Tele
				...
				CreateTeleporter(4663, 1134, 13, 4442, 1122, 5, map, false); //Moonglow Tele
				CreateTeleporter(5701, 1320, 16, 5786, 1336, -8, map, false); //Fire Dungeon
				...
				CreateTeleporter(5788, 1335, -13, 5703, 1319, 13, map, false); //Fire Dungeon
				//CreateTeleporter(6005, 1380, 1, 5151, 4063, 37, map, false); //Delucia Tunnel
				...
				//CreateTeleporter(6025, 1346, -26, 5137, 3665, 31, map, false); //T2A Passage Exit
				CreateTeleporter(5687, 1424, 38, 2923, 3406, 8, map, false); //Fire Dungeon Entrance
				//CreateTeleporter(5792, 1416, 41, 5758, 2908, 15, map, false);
				//CreateTeleporter(5792, 1417, 41, 5758, 2909, 15, map, false);
				//CreateTeleporter(5792, 1415, 41, 5758, 2907, 15, map, false); //Fire Dungeon T2A Entrance
				//CreateTeleporter(5899, 1411, 43, 1630, 3320, 0, map, false); //Del Passage
				...
				//CreateTeleporter(5961, 1409, 59, 5918, 1412, -29, map, false); //Del Passage
				//CreateTeleporter(6125, 1411, 15, 6075, 3332, 4, map, false); //T2A Sewer Passage
				...
				//CreateTeleporter(6138, 1409, 2, 6140, 1432, 4, map, false); //T2A Sewer Passage
				CreateTeleporter(6140, 1430, 4, 1627, 1591, -20, map, false); //Sewer to Poker Room
				CreateTeleporter(6141, 1430, 4, 1628, 1591, -20, map, false);
                CreateTeleporter(1627, 1591, -20, 6140, 1430, 4, map, false);
                CreateTeleporter(1628, 1591, -20, 6141, 1430, 4, map, false); //Poker Room to Sewer
                CreateTeleporter(4496, 1475, 15, 4442, 1122, 5, map, false); //Moonglow tele
				CreateTeleporter(6031, 1501, 42, 1491, 1642, 24, map, false); //Brit Sewer
				CreateTeleporter(6031, 1499, 42, 1491, 1640, 24, map, false);
				CreateTeleporter(1491, 1640, 24, 6032, 1499, 31, map, false);
				CreateTeleporter(1491, 1642, 24, 6032, 1501, 31, map, false); //Brit Sewer
                ...
                //CreateTeleporter(1987, 2062, -40, 5826, 464, 0, map, false); //T2A Marbe Passage
                //CreateTeleporter(1988, 2062, -40, 5827, 464, -1, map, false);
                //CreateTeleporter(1989, 2062, -40, 5828, 464, -1, map, false; //T2A Marbe Passage
                //CreateTeleporter(5203, 2327, 27, 5876, 147, 25, map, false); //T2A to Ice Dungeon
				//CreateTeleporter(5207, 2322, 27, 5877, 147, 25, map, false);
				//CreateTeleporter(5207, 2323, 26, 5876, 147, 25, map, false); //T2A to Ice Dungeon
				//CreateTeleporter(5670, 2391, 40, 5753, 325, 10, map, false); //T2A Passage
				CreateTeleporter(5974, 2697, 35, 2985, 2890, 35, map, false); //Ocean Teleporter
				CreateTeleporter(5267, 2757, 35, 424, 3283, 35, map, false); //Ocean Teleporter
				...
				//CreateTeleporter(5736, 3196, 8, 4545, 851, 30, map, false ); //Papua Tele
				DestroyTeleporter(5736, 3196, 8, map);
				CreateTeleporter(424, 3283, 35, 5267, 2757, 35, map, false);
				//CreateTeleporter(1629, 3320, 0, 5899, 1411, 43, map, false); //T2A Trinsic Passage
				...
				//CreateTeleporter(5150, 4062, 38, 6005, 1378, 0, map, false); //T2A Del
				//CreateTeleporter(5150, 4063, 38, 6005, 1380, 1, map, false); //T2A Del
