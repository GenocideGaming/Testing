...
namespace Server.SkillHandlers
{
    class Meditation
    {
        ...
        public static bool CheckOkayHolding(Item item)
        {
            ...
            if (item is Spellbook || item is Runebook || item is OrderShield || item is ChaosShield)
                return true;
        ...
        public static TimeSpan OnUse(Mobile m)
        {
            ...
            else
            {
                ...
                //Fire Off Skill Check Regardless For Skill Gain
                m.CheckSkill(SkillName.Meditation, 0.0, 100.0);

                if (skillVal >= 100.0) //Automatic Success
                {
