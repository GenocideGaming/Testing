        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile)
                {
                    if (targeted is BaseCreature)
                    {
                        ...
                        //Not Minimum Taming Skill Required
                        else
                        {
            ...
            private class InternalTimer : Timer
            {
                ...
                protected override void OnTick()
                {
                    ...
                    //Over 6 Spaces Away from Creature
                    ...
                    //Can't See or Out of LOS of Creature
                    ...
                    //Creature Must Be Subdued First
                    ...
                    //Creature Took Damage and is Too Angry to Tame
                    ...
                    //Normal Taming: Several of These Occur
                    else if (m_Count < m_MaxCount)
                    {
                        ...
                        //Check Animal Lore Skillgain						
                        m_Tamer.CheckTargetSkill(SkillName.AnimalLore, m_Creature, 0.0, 100.0);
                    ...
                    else
                    {
                        ...
                        minSkill += m_Creature.Owners.Count * 25;

                        //Taming Success						
                        if (CheckMastery(m_Tamer, m_Creature) || alreadyOwned || m_Tamer.CheckTargetSkill(SkillName.AnimalTaming, m_Creature, minSkill, minSkill + FeatureList.Followers.AnimalTamingDifficultyModifier))
                        {
                            //Retamed Same Creature
                            if (alreadyOwned)
                            {
                                m_Tamer.SendLocalizedMessage(502797); // That wasn't even challenging.

                                m_Creature.Aggressors.Clear();
                                m_Creature.Warmode = false;

                                m_Creature.StopDeleteTimer();
                            }
                            ...
                            else
                            {
                                ...
                                PlayerMobile playerTamer = m_Tamer as PlayerMobile;

                                if (playerTamer != null)
                                    playerTamer.AnimalsTamedThisSession++;
                            }
