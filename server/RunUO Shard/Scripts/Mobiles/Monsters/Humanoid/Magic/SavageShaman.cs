...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public SavageShaman() : base( AIType.AI_Generic, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
            ...
            Item tribalMask = new TribalMask(Utility.RandomDyedHue());
            tribalMask.Movable = false;
            AddItem(tribalMask); 
            ...
            switch (Utility.Random(2))
            {
                ...
                case 1: AddItem(new GnarledStaff()); break;               
            }           
		}
				...
				switch ( Utility.Random( 3 ) )
				{
					...
					case 1: /* lightning */
					{
						foreach ( Mobile m in list )
						{
							...
							SpellHelper.Damage( TimeSpan.FromSeconds( 0.25 ), m, this, damage, true );
						}
