	...
	public class SBMage : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( BlankScroll ), 5, 500, 0x0E34, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( BlackPearl ), 6, 500, 0xF7A, 0 ) );
				Add( new GenericBuyInfo( typeof( Bloodmoss ), 6, 500, 0xF7B, 0 ) );
				Add( new GenericBuyInfo( typeof( Garlic ), 4, 500, 0xF84, 0 ) );
				Add( new GenericBuyInfo( typeof( Ginseng ), 4, 500, 0xF85, 0 ) );
				Add( new GenericBuyInfo( typeof( MandrakeRoot ), 4, 500, 0xF86, 0 ) );
				Add( new GenericBuyInfo( typeof( Nightshade ), 4, 500, 0xF88, 0 ) );
				Add( new GenericBuyInfo( typeof( SpidersSilk ), 4, 500, 0xF8D, 0 ) );
				Add( new GenericBuyInfo( typeof( SulfurousAsh ), 4, 500, 0xF8C, 0 ) );
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				for ( int i = 0; i < types.Length; ++i )
					Add(types[i], (i + 3 + (i / 4)) / 3);     //we have reduced the value of the scrolls by 3
