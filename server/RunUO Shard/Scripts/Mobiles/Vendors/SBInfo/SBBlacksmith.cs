	...
	{ 
		...
		{ 
			...
			{ 	
				...
				Add( new GenericBuyInfo( typeof( PlateHelm ), 18, 20, 0x1419, 0 ) );
		...
		{ 
			...
			{ 
				...
				Add( typeof( MetalShield ), 39 );
				Add( typeof( MetalKiteShield ), 45 );
				Add( typeof( HeaterShield ), 60 );
				Add( typeof( WoodenKiteShield ), 21 );

				Add( typeof( WoodenShield ), 15 );

				Add( typeof( PlateArms ), 69 );
				Add( typeof( PlateChest ), 105 );
				Add( typeof( PlateGloves ), 45 );
				Add( typeof( PlateGorget ), 33 );
				Add( typeof( PlateLegs ), 93 );
				...
				Add( typeof( ChainChest ), 57 );
				Add( typeof( ChainLegs ), 51 );
				...
				Add( typeof( HeavyCrossbow ), 21 );
				Add( typeof( Bow ), 12 );
				Add( typeof( Crossbow ), 12 ); 
