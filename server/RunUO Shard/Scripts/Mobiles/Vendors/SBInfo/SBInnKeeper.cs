	...
	public class SBInnKeeper : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( EmptyPewterBowl ), 3, 20, 0x15FD, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( Beeswax ), 3, 20, 0x1422, 0 ) );

				Add( new GenericBuyInfo( typeof( Backpack ), 15, 20, 0x9B2, 0 ) );
				Add( new GenericBuyInfo( "1016450", typeof( Chessboard ), 3, 20, 0xFA6, 0 ) );
				Add( new GenericBuyInfo( "1016449", typeof( CheckerBoard ), 3, 20, 0xFA6, 0 ) );
				Add( new GenericBuyInfo( typeof( Backgammon ), 3, 20, 0xE1C, 0 ) );
				Add( new GenericBuyInfo( typeof( Dices ), 3, 20, 0xFA7, 0 ) );
                Add(new GenericBuyInfo( typeof( DiceCeeLo ), 4, 20, 0xFA7, 0));
