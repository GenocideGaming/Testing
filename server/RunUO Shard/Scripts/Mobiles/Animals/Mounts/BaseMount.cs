...
namespace Server.Mobiles
{
    ...
    public abstract class BaseMount : BaseCreature, IMount
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (!CheckMountAllowed(from, this, true, false) || !CheckRegionMountAllowed(from))
                return;
        ...
        public static bool CheckRegionMountAllowed(Mobile from)
        {
            if (from.Region is DungeonRegion)
            {
                from.SendMessage("You cannot mount in a dungeon.");
                return false;
            }
