...
namespace Server
{
	public class OppositionGroup
	{
        ...
        private static OppositionGroup m_DogsCatsAndRats = new OppositionGroup(new Type[][]
			{
				new Type[]
				{
					typeof( Cat ),	
        ...
        public static OppositionGroup DogsCatsAndRats
        {
            get { return m_DogsCatsAndRats; }
        }
