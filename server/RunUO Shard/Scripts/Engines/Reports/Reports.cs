...
namespace Server.Engines.Reports
{
	public class Reports
	{
		...
		{
			return new PersistableObject[]{ CompileFactionMembershipChart(), CompileFactionReport(), CompileFactionTownReport(), CompileFactionLeaderboard() };
		}
		...
		public static Report CompileFactionTownReport()
		{
			...
			for ( int i = 0; i < towns.Count; ++i )
			{
				...
				item.Values.Add( town.Militia == null ? "Neutral" : town.Militia.Definition.FriendlyName );
