...
namespace Server.Engines.BulkOrders
{
	...
	public abstract class SmallBOD : Item
	{
		...
		[Constructable]
		public SmallBOD( int hue, int amountMax, Type type, int number, int graphic, bool requireExeptional, BulkMaterialType material ) : base( Core.AOS ? 0x14EF : 0x14EF )
		{
			Weight = 1.0;
		...
		public SmallBOD() : base( Core.AOS ? 0x14EF : 0x14EF )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}
