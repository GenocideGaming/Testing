...
namespace Server.Engines.BulkOrders
{
	...
	public abstract class LargeBOD : Item
	{
		...
		public LargeBOD( int hue, int amountMax, bool requireExeptional, BulkMaterialType material, LargeBulkEntry[] entries ) : base( Core.T2A ? 0x14EF : 0x14EF )
		{
			Weight = 1.0;
		...
		public LargeBOD() : base( Core.T2A ? 0x14EF : 0x14EF )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}
