...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
        ...
        private static readonly ConstructCallback BrazierDeed = new ConstructCallback(CreateBrazier);
        private static readonly ConstructCallback HangingSwords = new ConstructCallback(CreateHangingSwords);
        private static readonly ConstructCallback HangingAxes = new ConstructCallback(CreateHangingAxes);
        private static readonly ConstructCallback DecorativeShield = new ConstructCallback(CreateDecorativeShield);
        private static readonly ConstructCallback MiningCart = new ConstructCallback(CreateMiningCart);
        private static readonly ConstructCallback SuitOfArmor = new ConstructCallback(CreateSuitOfArmor);
        private static readonly ConstructCallback PhoenixTicket = new ConstructCallback(CreatePhoenixTicket);
		...
		{
			if ( type == 10 || type == 15 || type == 20 || type == 25 || type == 30 || type == 40 || type == 50 || type == 60 )
				return new ImbuingHammer( type );

			throw new InvalidOperationException();
		}
        private static Item CreateBrazier(int type)
        {
            return new RewardBrazierDeed();
        }
        private static Item CreateHangingSwords(int type)
        {
            return new HangingSwordsDeed();
        }
        private static Item CreateHangingAxes(int type)
        {
            return new HangingAxesDeed();
        }
        private static Item CreateDecorativeShield(int type)
        {
            return new DecorativeShieldDeed();
        }
        private static Item CreateMiningCart(int type)
        {
            return new MiningCartDeed();
        }
        private static Item CreateSuitOfArmor(int type)
        {
            switch (Utility.Random(2))
            {
                default:
                case 0: return new SuitOfSilverArmorDeed();
                case 1: return new SuitOfGoldArmorDeed();
            }
        }
        private static Item CreatePhoenixTicket(int type)
        {
            return new PhoenixTicket();
        }
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup(  500, new RewardItem( 1, AncientHammer, 10 ) ),																								
					new RewardGroup(  550, new RewardItem( 3, AncientHammer, 10 ), new RewardItem( 2, AncientHammer, 15 ) ),
					new RewardGroup(  600, new RewardItem( 1, AncientHammer, 15 ) ),												  
					new RewardGroup(  625, new RewardItem( 3, AncientHammer, 15 ), new RewardItem( 6, PowerScroll, 5 ), new RewardItem( 1, ColoredAnvil ) ),
					new RewardGroup(  650, new RewardItem( 1, AncientHammer, 20 ) ),	 										  
					new RewardGroup(  675, new RewardItem( 1, ColoredAnvil ), new RewardItem( 6, BrazierDeed ), new RewardItem( 3, AncientHammer, 20 ) ),
					new RewardGroup(  700, new RewardItem( 1, AncientHammer, 25 ) ),	 
					new RewardGroup(  750, new RewardItem( 1, DecorativeShield ) ),																							
					new RewardGroup(  800, new RewardItem( 1, HangingSwords ) ),												  
					new RewardGroup(  850, new RewardItem( 1, MiningCart ) ),										  
					new RewardGroup(  900, new RewardItem( 1, HangingAxes ) ),	 
					new RewardGroup(  950, new RewardItem( 1, AncientHammer, 30 ) ),	 
					new RewardGroup( 1000, new RewardItem( 1, SuitOfArmor ) ), 
					new RewardGroup( 1050, new RewardItem( 1, AncientHammer, 40 ) ),	 
					new RewardGroup( 1100, new RewardItem( 1, PhoenixTicket ) ), 
					new RewardGroup( 1150, new RewardItem( 1, AncientHammer, 50 ) ),	 
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
        ...
        private static readonly ConstructCallback CurtainsDeed = new ConstructCallback(CreateCurtains);
        private static readonly ConstructCallback RangerTicket = new ConstructCallback(CreateRanger);
        ...
        private static int[][] m_ClothHues = new int[][]
			{
				...
				new int[]{ 0x497, 0x846, 0x484, 0x84C },
				new int[]{ 0x48E, 0x47F, 0x482, 0x492 }
			};
		...
		private static Item CreateRunicKit( int type )
        {
            if (type == 10 || type == 15 || type == 30 || type == 60)
                return new ImbuingSewingKit(type);
        ...
        private static Item CreateCurtains(int type)
        {
            return new CurtainsDeed();
        }
        private static Item CreateRanger(int type)
        {
            return new RangerTicket();
        }
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup( 350, new RewardItem( 3, Tapestry ) ),	
					new RewardGroup( 400, new RewardItem( 2, PowerScroll, 5 ) ), 
					new RewardGroup( 450, new RewardItem( 1, BearRug ) ),
					new RewardGroup( 500, new RewardItem( 1, RunicKit, 10 ) ),
					new RewardGroup( 550, new RewardItem( 1, ClothingBlessDeed ) ), 
					new RewardGroup( 575, new RewardItem( 1, CurtainsDeed ) ),  
					new RewardGroup( 600, new RewardItem( 1, RunicKit, 30 ) ),
					new RewardGroup( 650, new RewardItem( 1, RangerTicket ) ),  
					new RewardGroup( 700, new RewardItem( 1, RunicKit, 60 ) )
				};
		}
	}
