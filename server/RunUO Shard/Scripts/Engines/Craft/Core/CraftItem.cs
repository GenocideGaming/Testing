		...
		private static Type[][] m_TypesTable = new Type[][]
			{
				...
				new Type[]{ typeof( Cloth ), typeof( UncutCloth ), typeof( MilitiaCloth ) },
		...
		private static Type[] m_ColoredResourceTable = new Type[]
			{
				...
				typeof( UncutCloth ), typeof( Cloth ), typeof( MilitiaCloth ),
				typeof( BaseGranite )
			};
				...
				if ( item != null )
				{
					...
					if ( maxAmount > 0 )
					{
                        ...
                        else
                        {
                            if (item is Shaft)
                            {
                                maxAmount *= 2; //give two shafts per board
                            }
                    ...
                    if (player != null)
                        player.ItemsCraftedThisSession++;
				...
				if ( item is IFactionItem )
				{
					...
					if ( def != null )
					{
						...
						if ( faction != null )
						{
							...
							if ( town != null && town.Militia == faction )
							{
