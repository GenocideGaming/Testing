...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		{
			if ( type != typeof( Cloth ) && type != typeof( UncutCloth ) && type != typeof( MilitiaCloth ))
				return false;
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( OilCloth ), 1015283, 1041498, 64.6, 89.6, typeof( Cloth ), 1044286, 2, 1044287 );
			...
			AddCraft( typeof( LeatherGorget ), 1015293, 1025063, 53.9, 77.9, typeof( Leather ), 1044462, 4, 1044463 );
			...
			AddCraft( typeof( LeatherChest ), 1015293, 1025068, 67.5, 92.5, typeof( Leather ), 1044462, 12, 1044463 );

			#endregion

			#region Studded Armor
			AddCraft( typeof( StuddedGorget ), 1015300, 1025078, 78.8, 88.8, typeof( Leather ), 1044462, 6, 1044463 );
			AddCraft( typeof( StuddedGloves ), 1015300, 1025077, 72.9, 90.9, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( StuddedArms ), 1015300, 1025076, 67.1, 91.1, typeof( Leather ), 1044462, 10, 1044463 );
			AddCraft( typeof( StuddedLegs ), 1015300, 1025082, 72.2, 92.2, typeof( Leather ), 1044462, 12, 1044463 );
			AddCraft( typeof( StuddedChest ), 1015300, 1025083, 84.0, 93.0, typeof( Leather ), 1044462, 14, 1044463 );
			#endregion
			...
			AddCraft( typeof( StuddedBustierArms ), 1015306, 1027180, 82.9, 101.9, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( FemaleLeatherChest ), 1015306, 1027174, 62.2, 87.2, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( FemaleStuddedChest ), 1015306, 1027170, 87.1, 107.1, typeof( Leather ), 1044462, 10, 1044463 );
			#endregion

			#region Bone Armor
			index = AddCraft( typeof( BoneHelm ), 1049149, 1025206, 75.0, 93.0, typeof( Leather ), 1044462, 4, 1044463 );
			AddRes( index, typeof( Bone ), 1049064, 2, 1049063 );
			
			index = AddCraft( typeof( BoneGloves ), 1049149, 1025205, 79.0, 94.0, typeof( Leather ), 1044462, 6, 1044463 );
			AddRes( index, typeof( Bone ), 1049064, 2, 1049063 );

			index = AddCraft( typeof( BoneArms ), 1049149, 1025203, 82.0, 94.1, typeof( Leather ), 1044462, 8, 1044463 );
			AddRes( index, typeof( Bone ), 1049064, 4, 1049063 );

			index = AddCraft( typeof( BoneLegs ), 1049149, 1025202, 85.0, 95.0, typeof( Leather ), 1044462, 10, 1044463 );
			AddRes( index, typeof( Bone ), 1049064, 6, 1049063 );
		
			index = AddCraft( typeof( BoneChest ), 1049149, 1025199, 86.0, 98.0, typeof( Leather ), 1044462, 12, 1044463 );
			AddRes( index, typeof( Bone ), 1049064, 10, 1049063 );

			index = AddCraft(typeof(OrcHelm), 1049149, 1027947, 80.0, 94.0, typeof(Leather), 1044462, 6, 1044463);
			AddRes(index, typeof(Bone), 1049064, 4, 1049063);
			#endregion
            ...
            SetSubRes2(typeof(ArtifactOfGuarding), 1063490);
