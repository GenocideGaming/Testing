	...
	public class DefBlacksmithy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			*/
			...
			#region Platemail
			AddCraft( typeof( PlateArms ), 1011078, 1025136, 66.3, 100.0, typeof( IronIngot ), 1044036, 18, 1044037 );
			AddCraft( typeof( PlateGloves ), 1011078, 1025140, 58.9, 100.0, typeof( IronIngot ), 1044036, 12, 1044037 );
			AddCraft( typeof( PlateGorget ), 1011078, 1025139, 56.4, 100.0, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( PlateLegs ), 1011078, 1025137, 68.8, 92.8, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( PlateChest ), 1011078, 1046431, 75.0, 92.0, typeof( IronIngot ), 1044036, 25, 1044037 );
			...
			AddCraft( typeof( PlateHelm ), 1011079, 1025138, 62.6, 100.6, typeof( IronIngot ), 1044036, 15, 1044037 );
			#endregion

			#region Shields
			AddCraft( typeof( Buckler ), 1011080, 1027027, -25.0, 25.0, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddCraft( typeof( BronzeShield ), 1011080, 1027026, -5.2, 44.8, typeof( IronIngot ), 1044036, 12, 1044037 );
			AddCraft( typeof( HeaterShield ), 1011080, 1027030, 54.3, 94.3, typeof( IronIngot ), 1044036, 18, 1044037 );
			AddCraft( typeof( MetalShield ), 1011080, 1027035, -1.2, 49.8, typeof( IronIngot ), 1044036, 14, 1044037 );
			...
			AddCraft( typeof( ChaosShield ), 1011080, "chaos shield", 75.0, 105.0, typeof( IronIngot ), 1044036, 20, 1044037 );
			AddCraft( typeof( OrderShield ), 1011080, "order shield", 75.0, 105.0, typeof( IronIngot ), 1044036, 20, 1044037 );
			#endregion
			...
			AddCraft( typeof( Katana ),1011081, 1025119, 44.1, 88.1, typeof( IronIngot ), 1044036, 8, 1044037 );
			...
			AddCraft( typeof( WarAxe ), 1011082, 1025040, 39.1, 87.1, typeof( IronIngot ), 1044036, 16, 1044037 );
			#endregion
            ...
            AddCraft( typeof( ShortSpear ), 1011083, 1025123, 45.3, 95.3, typeof( IronIngot ), 1044036, 8, 1044037 );
			...
			#region Bashing
			AddCraft( typeof( Mace ), 1011084, 1023932, 14.5, 64.5, typeof( IronIngot ), 1044036, 8, 1044037 );
			AddCraft( typeof( Maul ), 1011084, 1025179, 19.4, 69.4, typeof( IronIngot ), 1044036, 10, 1044037 );
            AddCraft(typeof(WarMace), 1011084, 1015072, 28.0, 70.0, typeof(IronIngot), 1044036, 14, 1044037);
            AddCraft(typeof(WarHammer), 1011084, 1015073, 34.2, 84.2, typeof(IronIngot), 1044036, 16, 1044037);
