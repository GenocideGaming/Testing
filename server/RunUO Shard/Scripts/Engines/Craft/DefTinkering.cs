...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( Lockpick ), 1044046, 1025371, 45.0, 95.0, typeof( IronIngot ), 1044036, 2, 1044037 );
            ...
            //AddCraft(typeof(ImbuingHammer), 1044046, 1063515, 90.0, 100.0, typeof(IronIngot), 1044036, FeatureList.ArtifactCrafting.ImbuingToolIngotCost, 1044037);
            //AddCraft(typeof(ImbuingSaw), 1044046, 1063516, 90.0, 100.0, typeof(IronIngot), 1044036, FeatureList.ArtifactCrafting.ImbuingToolIngotCost, 1044037);
            //AddCraft(typeof(ImbuingSewingKit), 1044046, 1063517, 90.0, 100.0, typeof(IronIngot), 1044036, FeatureList.ArtifactCrafting.ImbuingToolIngotCost, 1044037);
            //AddCraft(typeof(ImbuingFletchingTools), 1044046, 1063518, 90.0, 100.0, typeof(IronIngot), 1044036, FeatureList.ArtifactCrafting.ImbuingToolIngotCost, 1044037);
			#endregion
			...
			AddCraft( typeof( Candelabra ), 1044050, 1022599, 50.0, 100.0, typeof( IronIngot ), 1044036, 4, 1044037 );
			AddCraft( typeof( Scales ), 1044050, 1026225, 55.0, 105.0, typeof( IronIngot ), 1044036, 4, 1044037 );
			AddCraft( typeof( Key ), 1044050, 1024112, 20.0, 70.0, typeof( IronIngot ), 1044036, 3, 1044037 );
			AddCraft( typeof( Globe ), 1044050, 1024167, 50.0, 100.0, typeof( IronIngot ), 1044036, 4, 1044037 );
			AddCraft( typeof( Spyglass ), 1044050, 1025365, 55.0, 105.0, typeof( IronIngot ), 1044036, 4, 1044037 );
			AddCraft( typeof( Lantern ), 1044050, 1022597, 30.0, 80.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			AddCraft( typeof( HeatingStand ), 1044050, 1026217, 55.0, 105.0, typeof( IronIngot ), 1044036, 4, 1044037 );


            index = AddCraft(typeof(FlashPowder), 1044050, 1063574, 70.0, 75.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, typeof(SulfurousAsh), 1023980, 1, 1044253);
			...
			// Faction Gas Trap
			index = AddCraft( typeof( FactionGasTrapDeed ), 1044052, 1044598, 65.0, 115.0, typeof( Silver ), 1044572, FeatureList.Militias.TrapDeedConstructionSilverCost, 1044253 );
			AddRes( index, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddRes( index, typeof( BasePoisonPotion ), 1044571, 1, 1044253 );

			// Faction explosion Trap
			index = AddCraft( typeof( FactionExplosionTrapDeed ), 1044052, 1044599, 65.0, 115.0, typeof( Silver ), 1044572, FeatureList.Militias.TrapDeedConstructionSilverCost , 1044253 );
			AddRes( index, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddRes( index, typeof( BaseExplosionPotion ), 1044569, 1, 1044253 );

			// Faction Saw Trap
			index = AddCraft( typeof( FactionSawTrapDeed ), 1044052, 1044600, 65.0, 115.0, typeof( Silver ), 1044572, FeatureList.Militias.TrapDeedConstructionSilverCost, 1044253 );
			AddRes( index, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddRes( index, typeof( Gears ), 1044254, 1, 1044253 );

			// Faction Spike Trap			
			index = AddCraft( typeof( FactionSpikeTrapDeed ), 1044052, 1044601, 65.0, 115.0, typeof( Silver ), 1044572, FeatureList.Militias.TrapDeedConstructionSilverCost, 1044253 );
			AddRes( index, typeof( IronIngot ), 1044036, 10, 1044037 );
			AddRes( index, typeof( Springs ), 1044171, 1, 1044253 );
