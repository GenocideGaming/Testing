...
namespace Server.Engines.Quests
{
    ...
    public abstract class QuestSystem
    {
        ...
        {
            typeof(Server.Engines.Quests.SupplyRecoveryQuest),
            typeof(Server.Engines.Quests.SurvivorRescueQuest),
            typeof(Server.Engines.Quests.PurgeUndeadQuest),
            typeof(Server.Engines.Quests.ScavengersHaulQuest),
            typeof(Server.Engines.Quests.OutpostTraderunQuest)
        };
