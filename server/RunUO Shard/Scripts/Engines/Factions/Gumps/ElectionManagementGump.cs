...
namespace Server.Factions
{
	public class ElectionManagementGump : Gump
	{
		...
		private CommonwealthElection m_Election;
		...
		public ElectionManagementGump( CommonwealthElection election ) : this( election, null, 0 )
		{
		}

		public ElectionManagementGump( CommonwealthElection election, Candidate candidate, int page ) : base( 40, 40 )
		{
			m_Election = election;
