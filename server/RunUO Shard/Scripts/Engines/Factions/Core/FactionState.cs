...
namespace Server.Factions
{
	public class FactionState
	{
        ...
        private ICommonwealth m_Commonwealth;
        private DateTime m_LastSilverTaxChange;

		private const int BroadcastsPerPeriod = 2;
		private static readonly TimeSpan BroadcastPeriod = TimeSpan.FromMinutes( FeatureList.Militias.CommanderBroadcastPeriodInMin );
		...
		public Mobile Commander
		{
			...
			set
			{
				...
				if ( m_Commander != null )
				{
                    m_Commander.SendMessage("You have been appointed commander of your faction!");
        ...
        public ICommonwealth MyCommonwealth { get { return m_Commonwealth; } set { m_Commonwealth = value; } }
		public int SilverTax
		{
			get{ return m_SilverTax; }
            set 
            {
                if (DateTime.Now - m_LastSilverTaxChange > TimeSpan.FromHours(FeatureList.Militias.SilverTaxChangeBlockTimeInHours))
                {
                    m_SilverTax = value;
                    m_LastSilverTaxChange = DateTime.Now;
                }
            }
		}
        public DateTime LastSilverTaxChange
        {
            get { return m_LastSilverTaxChange; }
            set { m_LastSilverTaxChange = value; }
        }
		public int Silver
		{
			get{ return m_Silver; }
		...
		public FactionState( GenericReader reader )
		{
			...
			switch ( version )
			{
                case 6:
                {
                    m_Commonwealth = Commonwealth.ReadReference(reader);
                    m_LastSilverTaxChange = reader.ReadDateTime();
                    goto case 5;
                }
				case 5:
				{
				...
				case 0:
				{
					...
					m_SilverTax = reader.ReadEncodedInt();
                    ...
                    if (m_Commonwealth == null)
                        m_Commonwealth = Commonwealth.Find(m_Faction.Definition.TownshipName);

                    m_Commonwealth.Militia = m_Faction;
		...
		public void Serialize( GenericWriter writer )
		{
            ...
            Commonwealth.WriteReference(writer, m_Commonwealth);
            writer.Write((DateTime)m_LastSilverTaxChange);
			...
			writer.WriteEncodedInt( (int) m_SilverTax );
