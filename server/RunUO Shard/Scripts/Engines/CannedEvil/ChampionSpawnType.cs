		...
		private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
			{
				...
				new ChampionSpawnInfo("Britain Invasion", typeof(Draga), new string[] { "Survivor", "Dissenter", "Revolutionary" }, new Type[][]	// Britain 
				{ // Britain Invasion
					new Type[] { typeof(RestlessSoul), typeof(RestlessSoul) }, // Level 1
					new Type[] { typeof(Skeleton), typeof(Zombie) }, // Level 2
					new Type[] { typeof(SkeletalMage), typeof(SkeletalKnight) }, // Level 3
					new Type[] { typeof(Mummy), typeof(Lich) }// Level 4
				}),
				new ChampionSpawnInfo("Forsaken", typeof(Haliax), new string[] { "Cleanser", "Purifier", "Absolver" }, new Type[][]	// Yew 
				{ // Dreadlords
					new Type[] { typeof(ForsakenMinion), typeof(ForsakenMinion) }, // Level 1
					new Type[] { typeof(ForsakenDK), typeof(ForsakenDK) }, // Level 2
					new Type[] { typeof(ForsakenNecromancer), typeof(ForsakenNecromancer) }, // Level 3
					new Type[] { typeof(Chandrian), typeof(Chandrian) }// Level 4
				}),
				new ChampionSpawnInfo("Urukhai", typeof(Gojira), new string[] { "Expeller", "Exterminator", "Annihilator" }, new Type[][]	// Blackrock
				{ // Uruk-Hai
					new Type[] { typeof(UrukGrunt), typeof(UrukGrunt) }, // Level 1
					new Type[] { typeof(UrukRaider), typeof(UrukRaider) }, // Level 2
					new Type[] { typeof(UrukShaman), typeof(UrukShaman) }, // Level 3
					new Type[] { typeof(UrukScout), typeof(UrukScout) }// Level 4
				}),
				new ChampionSpawnInfo("Paladin Order", typeof(DupreThePaladin), new string[] { "Corruptor", "Heretic", "Adulterator" }, new Type[][]	// Trinsic 
				{ // Paladin Order
					new Type[] { typeof(POSquire), typeof(POSquire) }, // Level 1
					new Type[] { typeof(POKnight), typeof(POKnight) }, // Level 2
					new Type[] { typeof(POPaladin), typeof(POPaladin) }, // Level 3
					new Type[] { typeof(Amyr), typeof(Amyr) }// Level 4
				}),
				new ChampionSpawnInfo("Minax Army", typeof(LadyMinaxChampion), new string[] { "Enemy", "Liberator", "Emancipator" }, new Type[][]	// Britain 
				{ // Minax
					new Type[] { typeof(Defiler), typeof(ExodusDrone) }, // Level 1
					new Type[] { typeof(Executioner), typeof(ExodusOverseer) }, // Level 2
					new Type[] { typeof(Warlord), typeof(ExodusZealot) }, // Level 3
					new Type[] { typeof(DreadKnight), typeof(ExodusJuggernaut) }// Level 4
				}),
				new ChampionSpawnInfo("Pirate Scourge", typeof(Kvothe), new string[] { "E'lir", "Re'lar", "El'the" }, new Type[][]	// Bucs Den
				{ // Kvothe the Bloodless
					new Type[] { typeof(UndeadPirate), typeof(UndeadPirate) }, // Level 1
					new Type[] { typeof(POKnight), typeof(POKnight) }, // Level 2
					new Type[] { typeof(POPaladin), typeof(POPaladin) }, // Level 3
					new Type[] { typeof(Amyr), typeof(Amyr) }// Level 4
				})
