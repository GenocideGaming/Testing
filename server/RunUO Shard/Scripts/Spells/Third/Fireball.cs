...
namespace Server.Spells.Third
{
	public class FireballSpell : MagerySpell
	{
        ...
        public override int BaseDamage { get { return 12; } }
		...
		public override double DamageDelay { get { return .75; } }
		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckHSequence( m ) )
			{
                ...
                //Damage Bonus When Cast By Players Against Creatures
                if (Caster.Player && creature != null && creature.TakesNormalDamage == false)
                    damage *= FeatureList.SpellChanges.FireballCreatureDamageMod;

                bool interrupt = CheckInterrupt(m, InterruptChance);
