...
namespace Server.Spells.Third
{
	public class WallOfStoneSpell : MagerySpell
	{
        ...
        public override bool CheckCast()
        {
            ...
            if (bc != null && bc.NetState != null && bc.Pseu_TeleWallDelay && bc.NextWallOfStone > DateTime.Now)
            {
            ...
            if (pm != null && pm.NextWallOfStone > DateTime.Now) 
            {
		...
		public void Target( IPoint3D p )
		{
            ...
            PlayerMobile pm = Caster as PlayerMobile;
            if (bc != null)
                bc.NextWallOfStone = DateTime.Now + TimeSpan.FromSeconds(FeatureList.SpellChanges.WallOfStoneRecastDelay);
            if (pm != null)
                pm.NextWallOfStone = DateTime.Now + TimeSpan.FromSeconds(FeatureList.SpellChanges.WallOfStoneRecastDelay);
