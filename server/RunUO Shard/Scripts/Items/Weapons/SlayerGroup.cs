...
namespace Server.Items
{
	public class SlayerGroup
	{
		...
		static SlayerGroup()
		{
			...
			undead.Super = new SlayerEntry( SlayerName.Silver, typeof( AncientLich ), typeof( Bogle ), typeof( BoneKnight ), typeof( BoneMagi ), typeof( Ghoul ), typeof( HellSteed ), typeof( Lich ), typeof( LichLord ), typeof( Mummy ),  typeof( RottingCorpse ), typeof( Shade ), typeof( SkeletalKnight ), typeof( SkeletalMage ), typeof( SkeletalMount ), typeof( Skeleton ), typeof( Spectre ), typeof( Wraith ), typeof( Zombie ) );
			undead.Entries = new SlayerEntry[0];

			fey.Opposition = new SlayerGroup[]{ abyss };
			fey.Super = new SlayerEntry( SlayerName.Fey, typeof( Centaur ), typeof( EtherealWarrior ), typeof( Kirin ), typeof( LordOaks ), typeof( Pixie ), typeof( Silvani ), typeof( Unicorn ), typeof( Wisp ));
			...
			elemental.Super = new SlayerEntry( SlayerName.ElementalBan, 
                typeof( ToxicElemental ), typeof( AgapiteElemental ), typeof( AirElemental ), 
                typeof( SummonedAirElemental ), typeof( BloodElemental ), typeof( BronzeElemental ), 
                typeof( CopperElemental ), typeof( DullCopperElemental ), typeof( EarthElemental ), 
                typeof( SummonedEarthElemental ), typeof( Efreet ), typeof( FireElemental ), 
                typeof( SummonedFireElemental ), typeof( GoldenElemental ), typeof( IceElemental ), 
                typeof( PoisonElemental ), typeof( SandVortex ), typeof( ShadowIronElemental ), 
                typeof( SnowElemental ), typeof( ValoriteElemental ), typeof( VeriteElemental ), 
                typeof( WaterElemental ), typeof( SummonedWaterElemental ),
                typeof( ElderWaterElemental), typeof( SteamElemental), typeof( FrozenElemental));
			...
			if( Core.AOS )
			{
				abyss.Super = new SlayerEntry( SlayerName.Exorcism,  typeof( ArcaneDaemon ), typeof( Balron ), typeof( ChaosDaemon ), typeof( Daemon ), typeof( SummonedDaemon ), typeof( EnslavedGargoyle ), typeof( FireGargoyle ), typeof( Gargoyle ), typeof( GargoyleDestroyer ), typeof( GargoyleEnforcer ), typeof( HordeMinion ), typeof( IceFiend ), typeof( Imp ),  typeof( Moloch ), typeof( Semidar ), typeof( StoneGargoyle ), typeof( Succubus ));
			...
			{
				abyss.Super = new SlayerEntry( SlayerName.Exorcism, typeof( Balron ), typeof( ChaosDaemon ), typeof( Daemon ), typeof( SummonedDaemon ),  typeof( Gargoyle ), typeof( FireGargoyle ),  typeof( HordeMinion ), typeof( IceFiend ), typeof( Imp ), typeof( StoneGargoyle ), typeof( ArcaneDaemon ), typeof( EnslavedGargoyle ), typeof( GargoyleDestroyer ), typeof( GargoyleEnforcer ), typeof( Moloch ) );

				abyss.Entries = new SlayerEntry[]
					{
						new SlayerEntry( SlayerName.DaemonDismissal, typeof( Balron ),  typeof( ChaosDaemon ), typeof( Daemon ), typeof( SummonedDaemon ), typeof( HordeMinion ), typeof( IceFiend ), typeof( Imp ), typeof( ArcaneDaemon ), typeof( Moloch ) ),
			...
			reptilian.Entries = new SlayerEntry[]
				{
					...
					new SlayerEntry( SlayerName.SnakesBane, typeof( DeepSeaSerpent ), typeof( GiantIceWorm ), typeof( GiantSerpent ), typeof( IceSerpent ), typeof( IceSnake ), typeof( LavaSerpent ), typeof( LavaSnake ), typeof( SeaSerpent ), typeof( Serado ), typeof( SilverSerpent ), typeof( Snake ) )
				};
