...
namespace Server.Items
{
	...
	public class CustomHuePicker
	{
        ...
        public static readonly CustomHuePicker LeatherDyeTubDullCopper = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Dull Copper */
				new CustomHueGroup( 1018332, new int[]{ 2419, 2420, 2421, 2422, 2423, 2424 } ),
        ...
        public static readonly CustomHuePicker LeatherDyeTubShadowIron = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Shadow Iron */
				new CustomHueGroup( 1018333, new int[]{ 2406, 2407, 2408, 2409, 2410, 2411, 2412 } ),
        ...
        public static readonly CustomHuePicker LeatherDyeTubCopper = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Copper */
				new CustomHueGroup( 1018334, new int[]{ 2413, 2414, 2415, 2416, 2417, 2418 } ),
        ...
        public static readonly CustomHuePicker LeatherDyeTubBronze = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Bronze */
				new CustomHueGroup( 1018335, new int[]{ 2414, 2415, 2416, 2417, 2418 } ),
        ...
        public static readonly CustomHuePicker LeatherDyeTubGolden = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Golden */
				new CustomHueGroup( 1018336, new int[]{ 2213, 2214, 2215, 2216, 2217, 2218 } ),
				
			}, true);
        public static readonly CustomHuePicker LeatherDyeTubAgapite = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Agapite */
				new CustomHueGroup( 1018337, new int[]{ 2425, 2426, 2427, 2428, 2429, 2430 } ),
				
			}, true);
        public static readonly CustomHuePicker LeatherDyeTubVerite = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Verite */
				new CustomHueGroup( 1018338, new int[]{ 2207, 2208, 2209, 2210, 2211, 2212 } ),
				
			}, true);
        public static readonly CustomHuePicker LeatherDyeTubValorite = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Valorite */
				new CustomHueGroup( 1018339, new int[]{ 2219, 2220, 2221, 2222, 2223, 2224 } ),
				
			}, true);
        public static readonly CustomHuePicker LeatherDyeTubReds = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Reds */
				new CustomHueGroup( 1018340, new int[]{ 2113, 2114, 2115, 2116, 2117, 2118 } ),
				
			}, true);
        public static readonly CustomHuePicker LeatherDyeTubBlues = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Blues */
				new CustomHueGroup( 1018341, new int[]{ 2119, 2120, 2121, 2122, 2123, 2124 } ),
				
			}, true);
        public static readonly CustomHuePicker LeatherDyeTubGreens = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Greens */
				new CustomHueGroup( 1018342, new int[]{ 2126, 2127, 2128, 2129, 2130 } ),
				
			}, true);
        public static readonly CustomHuePicker LeatherDyeTubYellows = new CustomHuePicker(new CustomHueGroup[]
			{
				/* Yellows */
				new CustomHueGroup( 1018343, new int[]{ 2213, 2214, 2215, 2216, 2217, 2218 } )
