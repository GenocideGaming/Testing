...
namespace Server.Items
{
	public class LesserCurePotion : BaseCurePotion
	{
		private static CureLevelInfo[] m_OldLevelInfo = new CureLevelInfo[]
			{
				new CureLevelInfo( Poison.Lesser,  0.00 ), // 75% chance to cure lesser poison
				new CureLevelInfo( Poison.Regular, 0.00 ), // 50% chance to cure regular poison
				new CureLevelInfo( Poison.Greater, 0.00 )  // 15% chance to cure greater poison
			};
