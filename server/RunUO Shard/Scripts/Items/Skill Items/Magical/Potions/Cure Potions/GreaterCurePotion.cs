...
namespace Server.Items
{
	public class GreaterCurePotion : BaseCurePotion
	{
		private static CureLevelInfo[] m_OldLevelInfo = new CureLevelInfo[]
			{
				new CureLevelInfo( Poison.Lesser,  0.00 ), // 100% chance to cure lesser poison
				new CureLevelInfo( Poison.Regular, 0.00 ), // 100% chance to cure regular poison
				new CureLevelInfo( Poison.Greater, 0.00 ), // 100% chance to cure greater poison
				new CureLevelInfo( Poison.Deadly,  0.00 ), //  75% chance to cure deadly poison
				new CureLevelInfo( Poison.Lethal,  0.00 )  //  25% chance to cure lethal poison
			};
		...
		private static CureLevelInfo[] m_AosLevelInfo = new CureLevelInfo[]
			{
				...
				new CureLevelInfo( Poison.Deadly,  0.65 ),
