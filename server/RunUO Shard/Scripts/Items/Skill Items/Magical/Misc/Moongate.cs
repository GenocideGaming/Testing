...
namespace Server.Items
{
	...
	public class Moongate : Item
	{
		...
		public virtual void UseGate( Mobile m )
		{
            ...
            {
                BaseCreature.TeleportPetsButNotEscortables(m, m_Target); // Will not take escortables.
		...
		public virtual bool ValidateUse( Mobile from, bool message )
		{
            ...
            {
                CommonwealthRegion townRegion = Region.Find(Target, TargetMap) as CommonwealthRegion;
                ...
                {
                    from.SendMessage("You cannot travel directly into your town when your town hero is captured!");
                    return false;
                }

                if (townRegion != null && townRegion.MyCommonwealth != player.CitizenshipPlayerState.Commonwealth)
                {
                    from.SendMessage("You cannot travel directly into another town's city limits while you are a member of a militia.");
                    return false;
                }
            }
