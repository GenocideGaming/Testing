...
namespace Server.Items
{
    ...
    public abstract class BaseInstrument : Item, ICraftable, ISlayer
    {
        ...
        {
            UsesRemaining += ResourceUsesAdjustment();
        ...
        private int ResourceUsesAdjustment()
        {
            int uses = 0;
            ...
            if (attrInfo != null)
                uses += ((int)attrInfo.WeaponDurabilityLevel * 10);
        ...
        {
            double val = GetMobileDifficulty.GetDifficultyValue(targ);
