...
namespace Server.Items
{
	...
	public class OrcishKinMask : BaseHat
	{
		...
		[Constructable]
		public OrcishKinMask() : this( 0x8A4 ) // hue
		{
		}

		[Constructable]
		public OrcishKinMask( int hue ) : base( 0x141B, hue ) // 0x141B is the appearance.
		{
			Weight = 2.0;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
            ...
            // These two lines were causing the color revert on server restart. 
			//if ( Hue != 0x8A4 )   
			//	Hue = 0x8A4;
		}
	}
    ...
    public class Hood : BaseHat
    {
		...
		[Constructable]
		public Hood( int hue ) : base(0x5519, hue )
		{
			Weight = 1.0;
