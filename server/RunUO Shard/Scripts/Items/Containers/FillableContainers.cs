...
namespace Server.Items
{
	public abstract class FillableContainer : LockableContainer
	{
		...
		{
			bool canSpawn = ( m_Content != null && !Deleted && !Movable && Parent == null && !IsLockedDown && !IsSecure );
		...
		public void Respawn()
		{
			...
			if( IsTrapable && ( m_Content.Level > 1 || 4 > Utility.Random( 5 ) ) )
			{
				...
				TrapPower = m_Content.Level * Utility.RandomMinMax( 10, 20 );
		...
		public virtual void GenerateContent()
		{
            ...
            for (int i = 0; i < m_Content.Entries.Length; i++)
            {
                Item toAdd = m_Content.Construct(i);
                if (toAdd != null && !toAdd.Deleted)
                    DropItem(toAdd);
            }
		}
    ...
    [Flipable(0xE3D, 0xE3C)]
    public class T1SpawnableLargeCrate : FillableContainer
    {
        ...
        public override void AcquireContent()
        {
            ...
            m_Content = FillableContent.TownChestsT1;
        ...
        [Constructable]
        public T1SpawnableLargeCrate()
            : base(0xE3D)
        {
            Weight = 1.0;
        }

        public T1SpawnableLargeCrate(Serial serial)
            : base(serial)
        {
        }
    ...
    [Flipable(0x9A9, 0xE7E)]
    public class T1SpawnableSmallCrate : FillableContainer
    {
        ...
        [Constructable]
        public T1SpawnableSmallCrate()
            : base(0x9A9)
        {
            Weight = 1.0;
        }

        public T1SpawnableSmallCrate(Serial serial)
            : base(serial)
        {
        }
    ...
    [Flipable(0x9AA, 0xE7D)]
    public class T1SpawnableWoodenBox : FillableContainer
    {
        ...
        [Constructable]
        public T1SpawnableWoodenBox()
            : base(0x9AA)
        {
            Weight = 1.0;
        }

        public T1SpawnableWoodenBox(Serial serial)
            : base(serial)
        {
        }
    ...
    [Flipable(0x9A8, 0xE80)]
    public class T1SpawnableMetalBox : FillableContainer
    {
        ...
        [Constructable]
        public T1SpawnableMetalBox()
            : base(0x9A8)
        {
            Weight = 1.0;
        }

        public T1SpawnableMetalBox(Serial serial)
            : base(serial)
        {
        }
      ...
      public class T1SpawnableBarrel : FillableContainer
    {
        ...
        [Constructable]
        public T1SpawnableBarrel()
            : base(0xE77)
        {
            Weight = 1.0;
        }

        public T1SpawnableBarrel(Serial serial)
            : base(serial)
        {
        }
      ...
      [Flipable(0x9AB, 0xE7C)]
      public class T1SpawnableMetalChest : FillableContainer
      {
          ...
          [Constructable]
          public T1SpawnableMetalChest()
              : base(0x9AB)
          {
              Weight = 1.0;
          }

          public T1SpawnableMetalChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE41, 0xE40)]
      public class T1SpawnableMetalGoldenChest : FillableContainer
      {
          ...
          [Constructable]
          public T1SpawnableMetalGoldenChest()
              : base(0xE41)
          {
              Weight = 1.0;
          }

          public T1SpawnableMetalGoldenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE43, 0xE42)]
      public class T1SpawnableWoodenChest : FillableContainer
      {
          ...
          [Constructable]
          public T1SpawnableWoodenChest()
              : base(0xE43)
          {
              Weight = 1.0;
          }

          public T1SpawnableWoodenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0x9AB, 0xE7C)]
      public class T2SpawnableMetalChest : FillableContainer
      {
          ...
          public override void AcquireContent()
          {
              ...
              m_Content = FillableContent.TownChestsT2;
          ...
          [Constructable]
          public T2SpawnableMetalChest()
              : base(0x9AB)
          {
              Weight = 1.0;
          }

          public T2SpawnableMetalChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE41, 0xE40)]
      public class T2SpawnableMetalGoldenChest : FillableContainer
      {
          ...
          [Constructable]
          public T2SpawnableMetalGoldenChest()
              : base(0xE41)
          {
              Weight = 1.0;
          }

          public T2SpawnableMetalGoldenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE43, 0xE42)]
      public class T2SpawnableWoodenChest : FillableContainer
      {
          ...
          [Constructable]
          public T2SpawnableWoodenChest()
              : base(0xE43)
          {
              Weight = 1.0;
          }

          public T2SpawnableWoodenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0x9AB, 0xE7C)]
      public class T2DungeonMetalChest : FillableContainer
      {
          ...
          public override void AcquireContent()
          {
              ...
              m_Content = FillableContent.DungeonChestsT2;
          ...
          [Constructable]
          public T2DungeonMetalChest()
              : base(0x9AB)
          {
              Weight = 1.0;
          }

          public T2DungeonMetalChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE41, 0xE40)]
      public class T2DungeonMetalGoldenChest : FillableContainer
      {
          ...
          [Constructable]
          public T2DungeonMetalGoldenChest()
              : base(0xE41)
          {
              Weight = 1.0;
          }

          public T2DungeonMetalGoldenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE43, 0xE42)]
      public class T2DungeonWoodenChest : FillableContainer
      {
          ...
          [Constructable]
          public T2DungeonWoodenChest()
              : base(0xE43)
          {
              Weight = 1.0;
          }

          public T2DungeonWoodenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0x9A9, 0xE7E)]
      public class T2DungeonSmallCrate : FillableContainer
      {
          ...
          [Constructable]
          public T2DungeonSmallCrate()
              : base(0x9A9)
          {
              Weight = 1.0;
          }

          public T2DungeonSmallCrate(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE3D, 0xE3C)]
      public class T2DungeonLargeCrate : FillableContainer
      {
          ...
          [Constructable]
          public T2DungeonLargeCrate()
              : base(0xE3D)
          {
              Weight = 1.0;
          }

          public T2DungeonLargeCrate(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0x9AB, 0xE7C)]
      public class T3DungeonMetalChest : FillableContainer
      {
          ...
          public override void AcquireContent()
          {
              ...
              m_Content = FillableContent.DungeonChestsT3;
          ...
          [Constructable]
          public T3DungeonMetalChest()
              : base(0x9AB)
          {
              Weight = 1.0;
          }

          public T3DungeonMetalChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE41, 0xE40)]
      public class T3DungeonMetalGoldenChest : FillableContainer
      {
          ...
          [Constructable]
          public T3DungeonMetalGoldenChest()
              : base(0xE41)
          {
              Weight = 1.0;
          }

          public T3DungeonMetalGoldenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE43, 0xE42)]
      public class T3DungeonWoodenChest : FillableContainer
      {
          ...
          [Constructable]
          public T3DungeonWoodenChest()
              : base(0xE43)
          {
              Weight = 1.0;
          }

          public T3DungeonWoodenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0x9A9, 0xE7E)]
      public class T3DungeonSmallCrate : FillableContainer
      {
          ...
          [Constructable]
          public T3DungeonSmallCrate()
              : base(0x9A9)
          {
              Weight = 1.0;
          }

          public T3DungeonSmallCrate(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE3D, 0xE3C)]
      public class T3DungeonLargeCrate : FillableContainer
      {
          ...
          [Constructable]
          public T3DungeonLargeCrate()
              : base(0xE3D)
          {
              Weight = 1.0;
          }

          public T3DungeonLargeCrate(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0x9AB, 0xE7C)]
      public class T4DungeonMetalChest : FillableContainer
      {
          ...
          public override void AcquireContent()
          {
              ...
              m_Content = FillableContent.DungeonChestsT4;
          ...
          [Constructable]
          public T4DungeonMetalChest()
              : base(0x9AB)
          {
              Weight = 1.0;
          }

          public T4DungeonMetalChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE41, 0xE40)]
      public class T4DungeonMetalGoldenChest : FillableContainer
      {
          ...
          [Constructable]
          public T4DungeonMetalGoldenChest()
              : base(0xE41)
          {
              Weight = 1.0;
          }

          public T4DungeonMetalGoldenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE43, 0xE42)]
      public class T4DungeonWoodenChest : FillableContainer
      {
          ...
          [Constructable]
          public T4DungeonWoodenChest()
              : base(0xE43)
          {
              Weight = 1.0;
          }

          public T4DungeonWoodenChest(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0x9A9, 0xE7E)]
      public class T4DungeonSmallCrate : FillableContainer
      {
          ...
          [Constructable]
          public T4DungeonSmallCrate()
              : base(0x9A9)
          {
              Weight = 1.0;
          }

          public T4DungeonSmallCrate(Serial serial)
              : base(serial)
          {
          }
      ...
      [Flipable(0xE3D, 0xE3C)]
      public class T4DungeonLargeCrate : FillableContainer
      {
          ...
          [Constructable]
          public T4DungeonLargeCrate()
              : base(0xE3D)
          {
              Weight = 1.0;
          }

          public T4DungeonLargeCrate(Serial serial)
              : base(serial)
          {
          }
    ...
    public class FillableEntry
	{
        ...
        public FillableEntry(Type type, int amount) : this(1, new Type[] { type}, amount)
        {

        }
		public FillableEntry( Type type )
			: this( 1, new Type[] { type }, 1 )
		{
		}

		public FillableEntry( int weight, Type type )
			: this( weight, new Type[] { type }, 1 )
		{
		}
		...
		public FillableEntry( int weight, Type[] types, int amount )
		{
			m_Weight = weight;
			m_Types = types;
            m_Amount = amount;
		...
		public virtual Item Construct()
		{
            ...
            if(m_Amount != 1)
            {
                int minAmount = (int)(m_Amount - m_Amount * 0.5);
                int maxAmount = (int)(m_Amount + m_Amount * 0.5);
    ...
    public class FillableContent
	{
        ...
        public FillableEntry[] Entries { get { return m_Entries; } }
        ...
        public Item Construct(int i)
        {
            if(i < m_Entries.Length)
                return m_Entries[i].Construct();

            return null;
        }
        public static FillableContent TownChestsT1 = new FillableContent(
            1,
            new Type[] { },
            new FillableEntry[]
            {
                new FillableEntry(typeof(Gold), 20),
                new FillableEntry(Loot.GemTypes),
            });

        public static FillableContent TownChestsT2 = new FillableContent(
            2,
            new Type[] { },
            new FillableEntry[]
            {
                new FillableEntry(typeof(Gold), 40),
                new FillableEntry(1, Loot.GemTypes, 2),
            });

        public static FillableContent DungeonChestsT2 = new FillableContent(
           2,
           new Type[] { },
           new FillableEntry[]
            {
                new FillableEntry(typeof(Gold), 40),
                new FillableEntry(1, Loot.GemTypes, 2),
                new FillableEntry(1, Loot.LowScrollTypes, 1)
            });

        public static FillableContent DungeonChestsT3 = new FillableContent(
           3,
           new Type[] { },
           new FillableEntry[]
            {
                new FillableEntry(typeof(Gold), 60),
                new FillableEntry(1, Loot.GemTypes, 2),
                new FillableEntry(1, Loot.MedScrollTypes, 2)
            });

        public static FillableContent DungeonChestsT4 = new FillableContent(
           4,
           new Type[] { },
           new FillableEntry[]
            {
                new FillableEntry(typeof(Gold), 150),
                new FillableEntry(1, Loot.GemTypes, 3),
		...
		public static FillableContent FighterGuild = new FillableContent(
			...
			new FillableEntry[]
			{
				new FillableEntry( 12, Loot.ArmorTypes, 1 ),
				new FillableEntry(  8, Loot.WeaponTypes, 1 ),
				new FillableEntry(  3, Loot.ShieldTypes, 1 ),
				new FillableEntry(  1, typeof( Arrow ) )
			} );
		...
		public static FillableContent Jeweler = new FillableContent(
			...
			new FillableEntry[]
			{
				...
				new FillableEntry( 9, Loot.GemTypes, 1 )
			} );
