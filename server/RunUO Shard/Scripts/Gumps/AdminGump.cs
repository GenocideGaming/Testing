	...
	public class AdminGump : Gump
	{
		...
		public static void AccountDelete_Callback( Mobile from, bool okay, object state )
		{
			...
			if ( okay )
			{
                ...
                //DatabaseController.RemoveGameAccount(a.Username);
			...
			switch ( type )
			{
				...
				case 7:
				{
					...
					switch ( index )
					{
						...
						case 6:
						{
							EntityProperties.SetValue( from, m, "Blessed", "False" );
							notice = "They are now mortal.";
							break;
						}
						case 7:
						{
							EntityProperties.SetValue( from, m, "Blessed", "True" );
							notice = "They are now immortal.";
							break;
						}
						case 8:
						{
							EntityProperties.SetValue( from, m, "Squelched", "True" );
							notice = "They are now squelched.";
							break;
						}
						case 9:
						{
							EntityProperties.SetValue( from, m, "Squelched", "False" );
							notice = "They are now unsquelched.";
							break;
						}
						case 10:
						{
							EntityProperties.SetValue( from, m, "Hidden", "True" );
							notice = "They are now hidden.";
							break;
						}
						case 11:
						{
							EntityProperties.SetValue( from, m, "Hidden", "False" );
