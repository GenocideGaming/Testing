		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			switch ( info.ButtonID )
			{
				case 1: // Rename sign
				{
                    ...
                    {
                        from.SendMessage("You must be at least a co-owner to do that!");
                    }
					break;
				}
				...
				case 17: // Declare public/private
				{
					if ( isOwner )
					{
						...
						else
						{
							m_House.RemoveKeys( from );
							m_House.RemoveLocks();
							from.SendMessage( "This house is now public. Friends of the house may now have vendors working out of this building." );//This house is now public. Friends of the house my now have vendors working out of this building.
						}
					}
					else
					{
