...
namespace Server.Gumps
{
	public class HouseDemolishGump : Gump
	{
		...
		public HouseDemolishGump( Mobile mobile, BaseHouse house ) : base( 110, 100 )
		{
            ...
            AddHtml(10, 40, 400, 200, "You are about to demolish your house. You will be refunded 90% of the house's value directly to your bank box. All items in the house will remain behind and can be freely picked up by anyone. Once the house is demolished, anyone can attempt to place a new house on the vacant land. Are you sure you wish to continue?", false, true); 
			...
			if ( info.ButtonID == 1 && !m_House.Deleted )
			{
				if ( m_House.IsOwner( m_Mobile ) )
				{
					...
					else
					{
						...
						{
							toGive = new BankCheck( (int) Math.Floor ( m_House.DefaultPrice * FeatureList.Houses.ReturnPriceReduction ) );
						}
