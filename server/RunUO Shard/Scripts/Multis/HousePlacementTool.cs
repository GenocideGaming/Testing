...
namespace Server.Items
{
	...
	public class HousePlacementCategoryGump : Gump
	{
		...
		public HousePlacementCategoryGump( Mobile from ) : base( 50, 50 )
		{
            ...
            AddHtmlLocalized(45, 60, 200, 20, 1063533, LabelColor, false, false); // Rel Por Houses
		...
		public override void OnResponse( Server.Network.NetState sender, RelayInfo info )
		{
			...
			switch ( info.ButtonID )
			{
				...
				/*
				case 2: // Rel Por Houses
				{
					m_From.SendGump( new HousePlacementListGump( m_From, HousePlacementEntry.RelWisHouses ) );
					break;
				}
				*/
            }
	...
	public class HousePlacementEntry
	{
		...
		private static HousePlacementEntry[] m_ClassicHouses = new HousePlacementEntry[]
			{
				new HousePlacementEntry( typeof( SmallOldHouse ),		1011303,	150,	25,	    489,	244,	10,	74000,		0,	4,	0,	0x0064	),
				new HousePlacementEntry( typeof( SmallOldHouse ),		1011304,	150,	25, 	489,	244,	10,	74000,		0,	4,	0,	0x0066	),
				new HousePlacementEntry( typeof( SmallOldHouse ),		1011305,	150,	25,	    489,	244,	10,	74000,		0,	4,	0,	0x0068	),
				new HousePlacementEntry( typeof( SmallOldHouse ),		1011306,	150,	25,	    489,	244,	10,	74000,		0,	4,	0,	0x006A	),
				new HousePlacementEntry( typeof( SmallOldHouse ),		1011307,	150,	25,	    489,	244,	10,	74000,		0,	4,	0,	0x006C	),
				new HousePlacementEntry( typeof( SmallOldHouse ),		1011308,	150,	25,	    489,	244,	10,	74000,		0,	4,	0,	0x006E	),
				new HousePlacementEntry( typeof( SmallShop ),			1011321,	310,	60, 	489,	244,	10,	108000,	   -1,	4,	0,	0x00A0	),
				new HousePlacementEntry( typeof( SmallShop ),			1011322,	310,	60,	    489,	244,	10,	108000,		0,	4,	0,	0x00A2	),
				new HousePlacementEntry( typeof( SmallTower ),			1011317,	550,	175,	667,	333,	14,	180000,		3,	4,	0,	0x0098	),
				new HousePlacementEntry( typeof( TwoStoryVilla ),		1011319,	675,	175,	1265,	632,	24,	300000,		3,	6,	0,	0x009E	),
				new HousePlacementEntry( typeof( SandStonePatio ),		1011320,	675,	175,	1265,	632,	24,	300000,	   -1,	4,	0,	0x009C	),
				new HousePlacementEntry( typeof( LogCabin ),			1011318,	675,	175,	1265,	632,	24,	300000,		1,	6,	0,	0x009A	),
				new HousePlacementEntry( typeof( GuildHouse ),			1011309,	975,	225,	1576,	788,	28,	480000,	   -1,	7,	0,	0x0074	),
				new HousePlacementEntry( typeof( TwoStoryHouse ),		1011310,	975,	225,	1576,	788,	28,	480000,	   -3,	7,	0,	0x0076	),
				new HousePlacementEntry( typeof( TwoStoryHouse ),		1011311,	975,	225,	1576,	788,	28,	480000,	   -3,	7,	0,	0x0078	),
				new HousePlacementEntry( typeof( LargePatioHouse ),		1011315,	975,	225,	1576,	788,	28,	480000,	   -4,	7,	0,	0x008C	),
				new HousePlacementEntry( typeof( Tower ),				1011312,	1850,	350,	2437,	1218,	42,	940000,		0,	7,	0,	0x007A	),
			};
		...
		/*
        private static HousePlacementEntry[] m_RelWisHouses = new HousePlacementEntry[]
        {
            new HousePlacementEntry(typeof(MediumWoodAndPlaster),       1063535, 310, 60, 489, 244, 10, 110000, 0, 4, 0, 0xA3), //medium wood and plaster
            new HousePlacementEntry(typeof(MediumFieldstoneL),          1063534, 550, 175, 489, 244, 10, 140000, -4, 6, 0, 0xA4), //Medium Fieldstone L
            new HousePlacementEntry(typeof(WoodAndPlasterCabin),        1063536, 675, 175, 489, 244, 10, 330000, -2, 6, 0, 0xA5), //Wood And Plaster Cabin
            new HousePlacementEntry(typeof(TwoStoryFieldstonePatio),    1063538, 675, 175, 489, 244, 10, 320000, -4, 8, 0, 0xA7), //Two Story Fieldstone Patio
            new HousePlacementEntry(typeof(SmallWoodAndPlasterVilla),   1063558, 310, 60, 489, 244, 10, 90000, -2, 3, 0, 0xA8), //Small Wood And Plaster Villa
            new HousePlacementEntry(typeof(TwoStoryWoodBalcony),        1063537, 975, 225, 489, 244, 10, 420000, -3, 4, 0, 0xA6), //Two Story Wood Balcony
            new HousePlacementEntry(typeof(MediumFieldstonePatio),      1063539, 675, 175, 489, 244, 10, 280000, 6, -4, 0, 0xAB), //Medium Fieldstone Patio
            new HousePlacementEntry(typeof(LogCabinH),                  1063540, 675, 175, 489, 244, 10, 280000, -2, 4, 0, 0xAC), //Log Cabin H
            new HousePlacementEntry(typeof(LogCabinPatio),              1063541, 550, 175, 489, 244, 10, 160000, 1, 4, 0, 0xAD), //Log Cabin Patio
            new HousePlacementEntry(typeof(LargeStoneCompound),         1063542, 1425, 300, 489, 244, 10, 680000, 3, 6, 0, 0xAE), //Large Stone Compound,
            new HousePlacementEntry(typeof(LargeStoneDuelingPit),       1063543, 975, 225, 489, 244, 10, 480000, -3, 10, 0, 0xAF), //Large Stone Dueling Pit
            new HousePlacementEntry(typeof(MediumDuelingTower),         1063544, 1425, 300, 489, 244, 10, 680000, 0, 6, 0, 0xB0), //Medium Dueling Tower
            new HousePlacementEntry(typeof(LargeSandstonePatio),        1063545, 975, 225, 489, 244, 10, 450000, 8, -5, 0, 0xB1), //Large Sandstone Patio
            new HousePlacementEntry(typeof(MediumStoneCompound),        1063546, 975, 225, 489, 244, 10, 480000, 5, 6, 0, 0xB2), //Medium Stone Compound
            new HousePlacementEntry(typeof(StoneTower),                 1063547, 975, 225, 489, 244, 10, 520000, -1, 6, 0, 0xB3), //Stone Tower
            new HousePlacementEntry(typeof(BrickPorch),                 1063548, 675, 175, 489, 244, 10, 300000, 0, 6, 0, 0xB4), //Brick Porch
            new HousePlacementEntry(typeof(MediumMarbleShop),           1063549, 675, 175, 489, 244, 10, 300000, 3, 7, 0, 0xB5), //Medium Marble Shop
            new HousePlacementEntry(typeof(MediumBrickPatio),           1063550, 675, 175, 489, 244, 10, 330000, -5, 5, 0, 0xB6), //Medium Brick Patio
            new HousePlacementEntry(typeof(LargeBrickVilla),            1063551, 1425, 300, 489, 244, 10, 780000, -1, 6, 0, 0xB7), //Large Brick Villa
            new HousePlacementEntry(typeof(MediumSandstone),            1063552, 675, 175, 489, 244, 10, 300000, 6, -3, 0, 0xB8), //Medium Sandstone
            new HousePlacementEntry(typeof(BellTower),                  1063553, 675, 175, 489, 244, 10, 370000, 5, -2, 0, 0xB9), //Bell Tower
            new HousePlacementEntry(typeof(TwoStorySquareBrick),        1063554, 675, 175, 489, 244, 10, 360000, 0, 6, 0, 0xBA), //Two Story Square Brick
            new HousePlacementEntry(typeof(WoodAndPlasterF),            1063555, 675, 175, 489, 244, 10, 270000, 6, -5, 0, 0xBB), //Wood And Plaster F
            new HousePlacementEntry(typeof(TwoStoryBrickT),             1063556, 975, 225, 489, 244, 10, 520000, -2, 7, 0, 0xBC), //Two Story Brick T
            new HousePlacementEntry(typeof(WoodPatioTerrace),           1063557, 675, 175, 489, 244, 10, 380000, -4, 6, 0, 0xBD), //Wood Patio Terrace
            new HousePlacementEntry(typeof(FieldStoneShop),             1063559, 675, 175, 489, 244, 10, 300000, -4, 6, 0, 0xBE), //Field Stone Shop
            new HousePlacementEntry(typeof(HShapedWoodCabin),           1063561, 675, 175, 489, 244, 10, 280000, -2, 4, 0, 0xBF), //H-Shaped Wood Cabin
            new HousePlacementEntry(typeof(MediumTower),                1063562, 975, 225, 489, 244, 10, 520000, 0, 6, 0, 0xC0), //Medium Tower
            new HousePlacementEntry(typeof(RoacheMansion),              1063563, 1850, 350, 489, 244, 10, 940000, -4, 6, 0, 0xC1), //Roache Mansion
            new HousePlacementEntry(typeof(SmallBrickVilla),            1063564, 310, 60, 489, 244, 10, 90000, -2, 4, 0, 0xC2), //Small Brick Villa
            new HousePlacementEntry(typeof(SmallFieldStoneVilla),       1063565, 310, 60, 489, 244, 10, 90000, -2, 4, 0, 0xC3), //Small Field Stone Villa
            new HousePlacementEntry(typeof(SmallSandStoneVilla),        1063566, 310, 60, 489, 244, 10, 90000, -2, 4, 0, 0xC4), //Small Sandstone Villa
            new HousePlacementEntry(typeof(SmallWoodVilla),             1063567, 310, 60, 489, 244, 10, 90000, -2, 4, 0, 0xC5), //Small Wood Villa
            new HousePlacementEntry(typeof(WoodAndBrickMansion),        1063568, 1850, 350, 489, 244, 10, 940000, 6, 6, 0, 0xC6), //Wood And Brick Mansion
        };
        public static HousePlacementEntry[] RelWisHouses { get { return m_RelWisHouses; } }
		*/
	}
}