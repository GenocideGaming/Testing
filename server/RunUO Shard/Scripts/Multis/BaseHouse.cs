...
namespace Server.Multis
{
	public class HousingInfo
    {
        ...
        public int Lockdowns = 125;
        public int MaxSecures = 1;

        public HousingInfo(int cost, int lockdowns, int maxSecures)
        {
            Cost = cost;
            Lockdowns = lockdowns;
	...
	{
        public const string HousingConfigFile = "HousingConfig.txt";
        public const string HousingErrorFileName = "ERROR-housing.txt";

        public static Dictionary<Type,HousingInfo> HousingInfoDict = new Dictionary<Type,HousingInfo>(); 

        
        public static void Initialize()
        {
            CommandSystem.Register("RefreshAllHouses", AccessLevel.GameMaster, new CommandEventHandler(RefreshAllHouses_Command));
            CommandSystem.Register("UpdateHouseProperties", AccessLevel.GameMaster, new CommandEventHandler(UpdateHouseProperties_Command));
            LoadHousingInfo();
            foreach (HousePlacementEntry entry in HousePlacementEntry.ClassicHouses)
            {
                int lockdowns = GetHouseLockdowns(entry.Type);
                entry.Lockdowns = lockdowns;
                entry.Storage = lockdowns - (GetHouseSecures(entry.Type) * 125);
                entry.Cost = GetHouseCost(entry.Type);
            }
			/*
            foreach (HousePlacementEntry entry in HousePlacementEntry.RelPorFoundations)
            {
                int lockdowns = GetHouseLockdowns(entry.Type);
                entry.Lockdowns = lockdowns;
                entry.Storage = lockdowns - (GetHouseSecures(entry.Type) * 125);
        ...
        public static int GetHouseCost(Type type)
        {
            HousingInfo info;
            if (HousingInfoDict.TryGetValue(type, out info))
            {
                return info.Cost;
            }
            switch (type.Name)
            {
                case "SmallOldHouse": return 74000;
                case "SmallShop": return 108000;
                case "MediumWoodAndPlaster": return 110000;
                case "SmallWoodAndPlasterVilla": return 90000;
                case "SmallBrickVilla": return 90000;
                case "SmallFieldStoneVilla": return 90000;
                case "SmallSandStoneVilla": return 90000;
                case "SmallWoodVilla": return 90000;
                case "SmallTower": return 180000;
                case "LogCabinPatio": return 160000;
                case "MediumFieldstoneL": return 140000;
                case "LogCabin": return 300000;
                case "SandStonePatio": return 300000;
                case "TwoStoryVilla": return 300000;
                case "WoodAndPlasterCabin": return 330000;
                case "MediumFieldstonePatio": return 280000;
                case "LogCabinH": return 280000;
                case "TwoStoryFieldstonePatio": return 320000;
                case "BrickPorch": return 300000;
                case "MediumMarbleShop": return 300000;
                case "MediumBrickPatio": return 330000;
                case "MediumSandstone": return 300000;
                case "BellTower": return 370000;
                case "TwoStorySquareBrick": return 360000;
                case "WoodAndPlasterF": return 270000;
                case "WoodPatioTerrace": return 380000;
                case "FieldStoneShop": return 300000;
                case "HShapedWoodCabin": return 280000;
                case "GuildHouse": return 480000;
                case "TwoStoryHouse": return 480000;
                case "TwoStoryWoodBalcony": return 420000;
                case "LargePatioHouse": return 480000;
                case "LargeStoneDuelingPit": return 480000;
                case "LargeSandstonePatio": return 450000;
                case "MediumStoneCompound": return 480000;
                case "StoneTower": return 520000;
                case "TwoStoryBrickT": return 520000;
                case "MediumTower": return 520000;
                case "LargeStoneCompound": return 680000;
                case "MediumDuelingTower": return 680000;
                case "LargeBrickVilla": return 780000;
                case "Tower": return 940000;
                case "RoacheMansion": return 940000;
                case "WoodAndBrickMansion": return 940000;
            }
            return 10000000;
        }

        public static int GetHouseLockdowns(Type type)
        {
            HousingInfo info;
            if (HousingInfoDict.TryGetValue(type, out info))
            {
                return info.Lockdowns;
            }
            switch (type.Name)
            {
                case "SmallOldHouse": return 150;
                case "SmallShop": return 310;
                case "MediumWoodAndPlaster": return 310;
                case "SmallWoodAndPlasterVilla": return 310;
                case "SmallBrickVilla": return 310;
                case "SmallFieldStoneVilla": return 310;
                case "SmallSandStoneVilla": return 310;
                case "SmallWoodVilla": return 310;
                case "SmallTower": return 550;
                case "LogCabinPatio": return 550;
                case "MediumFieldstoneL": return 550;
                case "LogCabin": return 675;
                case "SandStonePatio": return 675;
                case "TwoStoryVilla": return 675;
                case "WoodAndPlasterCabin": return 675;
                case "MediumFieldstonePatio": return 675;
                case "LogCabinH": return 675;
                case "TwoStoryFieldstonePatio": return 675;
                case "BrickPorch": return 675;
                case "MediumMarbleShop": return 675;
                case "MediumBrickPatio": return 675;
                case "MediumSandstone": return 675;
                case "BellTower": return 675;
                case "TwoStorySquareBrick": return 675;
                case "WoodAndPlasterF": return 675;
                case "WoodPatioTerrace": return 675;
                case "FieldStoneShop": return 675;
                case "HShapedWoodCabin": return 675;
                case "GuildHouse": return 975;
                case "TwoStoryHouse": return 975;
                case "TwoStoryWoodBalcony": return 975;
                case "LargePatioHouse": return 975;
                case "LargeStoneDuelingPit": return 975;
                case "LargeSandstonePatio": return 975;
                case "MediumStoneCompound": return 975;
                case "StoneTower": return 975;
                case "TwoStoryBrickT": return 975;
                case "MediumTower": return 975;
                case "LargeStoneCompound": return 1425;
                case "MediumDuelingTower": return 1425;
                case "LargeBrickVilla": return 1425;
                case "Tower": return 1850;
                case "RoacheMansion": return 1850;
                case "WoodAndBrickMansion": return 1850;
            }
            return 125;
        }

        public static int GetHouseSecures(Type type)
        {
            HousingInfo info;
            if (HousingInfoDict.TryGetValue(type, out info))
            {
                return info.MaxSecures;
            }
            switch (type.Name)
            {
                case "SmallOldHouse": return 1;
                case "SmallShop": return 2;
                case "MediumWoodAndPlaster": return 2;
                case "SmallWoodAndPlasterVilla": return 2;
                case "SmallBrickVilla": return 2;
                case "SmallFieldStoneVilla": return 2;
                case "SmallSandStoneVilla": return 2;
                case "SmallWoodVilla": return 2;
                case "SmallTower": return 3;
                case "LogCabinPatio": return 3;
                case "MediumFieldstoneL": return 3;
                case "LogCabin": return 4;
                case "SandStonePatio": return 4;
                case "TwoStoryVilla": return 4;
                case "WoodAndPlasterCabin": return 4;
                case "MediumFieldstonePatio": return 4;
                case "LogCabinH": return 4;
                case "TwoStoryFieldstonePatio": return 4;
                case "BrickPorch": return 4;
                case "MediumMarbleShop": return 4;
                case "MediumBrickPatio": return 4;
                case "MediumSandstone": return 4;
                case "BellTower": return 4;
                case "TwoStorySquareBrick": return 4;
                case "WoodAndPlasterF": return 4;
                case "WoodPatioTerrace": return 4;
                case "FieldStoneShop": return 4;
                case "HShapedWoodCabin": return 4;
                case "GuildHouse": return 6;
                case "TwoStoryHouse": return 6;
                case "TwoStoryWoodBalcony": return 6;
                case "LargePatioHouse": return 6;
                case "LargeStoneDuelingPit": return 6;
                case "LargeSandstonePatio": return 6;
                case "MediumStoneCompound": return 6;
                case "StoneTower": return 6;
                case "TwoStoryBrickT": return 6;
                case "MediumTower": return 6;
                case "LargeStoneCompound": return 9;
                case "MediumDuelingTower": return 9;
                case "LargeBrickVilla": return 9;
                case "Tower": return 12;
                case "RoacheMansion": return 12;
                case "WoodAndBrickMansion": return 12;
            }
            return 1;
        }

        public static void LoadHousingInfo()
        {
            HousingInfoDict = new Dictionary<Type, HousingInfo>();
            Dictionary<Type, List<BaseHouse>> HousesToUpdate = new Dictionary<Type, List<BaseHouse>>();

            // need to go through and update all existing houses
            // open HousingConfig.txt, fill in Exemptions
            string line;
            ...
            try
            {
                System.IO.StreamReader file =
                   new System.IO.StreamReader(HousingConfigFile);
                while ((line = file.ReadLine()) != null)
                {
                    ...
                    try
                    {
                        // syntax: Type cost lockdowns
                        string typename = args[0];
                        int cost = int.Parse(args[1]);
                        int lockdowns = int.Parse(args[2]);
                        int maxSecures = int.Parse(args[3]);
                        HousingInfo newInfo = new HousingInfo(cost, lockdowns, maxSecures);

                        HousingInfoDict.Add(Type.GetType("Server.Multis." + typename), newInfo);
                        //if (gm != null) { gm.SendMessage("Watching: " + args[0]); }
                    }
                    catch (Exception e)
                    {
                        using (StreamWriter writer = new StreamWriter(HousingErrorFileName, true))
                        {
            ...
            foreach (BaseHouse house in m_AllHouses)
            {
                try
                {
                    HousingInfo info;
                    if (HousingInfoDict.TryGetValue(house.GetType(), out info))
                    {
                        house.MaxLockDowns = info.Lockdowns;
                        house.MaxSecures = info.MaxSecures;
                    }
                }
                catch (Exception e)
                {
        ...
        public static void UpdateHouseProperties_Command(CommandEventArgs e)
        {
            LoadHousingInfo();
        ...
        public static void RefreshAllHouses_Command(CommandEventArgs e)
        {
            foreach (BaseHouse house in m_AllHouses)
            {
                house.RefreshDecay();
            }
            e.Mobile.SendMessage("All houses on the server have been refreshed.");
        }
        ...
        public bool DoSingleRefresh
        {
            get { return false; }
            set { if (value == true) this.RefreshDecay(); }
        }
		...
		public virtual TimeSpan DecayPeriod{ get{ return TimeSpan.FromDays( 20.0 ); } }
		...
		public static bool CheckAccessible( Mobile m, Item item )
		{
			...
			{
				LockableContainer c = (LockableContainer)item;
			...
			if ( house.IsLockedDown( item ) )
				return true; //house.IsCoOwner( m ) && (item is Container);
		...
		public bool CheckAccessibility( Item item, Mobile from )
		{
			...
			if ( !IsLockedDown( item ) )
				...
				return true;
            else if (item is Dyes || item is DyeTub || item is Dices || item is DiceCeeLo)
                return true;
			else if ( item is ISecurable )
				return HasSecureAccess( from, ((ISecurable)item).Level );
			else if ( item is Container )
				return IsCoOwner( from );
			else if ( item.Stackable && !(item is Cloth) )
				return true;
		...
		{
            bool eastFacing = HasEastSign(m_Sign);

            if (m_Sign != null && !eastFacing)
                m_Sign.ItemID = itemID;
            else if (m_Sign != null && eastFacing)
                m_Sign.ItemID = itemID - 1;
		}
        ...
        public BaseDoor[] AddEastDoors(bool wood, int x, int y, int z)
        {
            ...
            return new BaseDoor[] { southDoor, northDoor };
        }
        ...
        public void SetEastSign(int xOff, int yOff, int zOff)
        {
            m_Sign = new HouseSign(this, true);
            m_Sign.MoveToWorld(new Point3D(this.X + xOff, this.Y + yOff, this.Z + zOff), this.Map);
        }
		...
		{
			HouseRegion fromRegion = (HouseRegion) from.Region.GetRegion( typeof( HouseRegion ) );
			HouseRegion targRegion = (HouseRegion) targ.Region.GetRegion( typeof( HouseRegion ) );
			...
			else if(fromRegion != null && targRegion != null && fromRegion != targRegion)
			{
				from.SendLocalizedMessage( 501352 ); // You may not eject someone who is not in your house!
			}
		...
		public override void OnDelete()
		{
			...
			if (FeatureList.Houses.DeleteGuildStonesAutomatically)
			{
				if ( FindGuildstone() != null )
				{
					Console.Write("Guildstone found");
					Guildstone gs = FindGuildstone();
					gs.Guild.Disband();
					gs.Delete();
				}
			}
        ...
        public bool HasEastSign(HouseSign sign)
        {
            if (sign.ItemID % 2 == 0)
                return false;
            else
