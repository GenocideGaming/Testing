...
namespace Server
{
	...
	public enum MapRules
	{
		...
		TrammelRules			= BeneficialRestrictions, //FreeMovement | BeneficialRestrictions | HarmfulRestrictions,
		FeluccaRules			= BeneficialRestrictions //None
	}
	...
	public sealed class Map : IComparable, IComparable<Map>
	{
		...
		*/
		...
		private class TypedEnumerator : IPooledEnumerator, IDisposable
		{
            ...
            public static void LogMapIssue(string msg) 
            {
		...
		private class SectorEnumerator : IPooledEnumerator, IDisposable
		{
			...
			public object Current
			{
				get
				{
					//return m_CurrentList[m_CurrentIndex];  // this was resulting in freezing...
					try
					{
			...
			public bool MoveNext()
			{
				while ( true )
				{
                    ...
                    {
                        TypedEnumerator.LogMapIssue("m_CurrentList is null!... what happens when we return false?");
                        return false;
                    }
