...
namespace Server.Items
{
	...
	public class Container : Item
	{
        ...
        private bool m_MovableContents = false; // if container is not Movable, then this property determines whether contents can be moved
        [CommandProperty(AccessLevel.GameMaster)]
        public bool MovableContents { get { return m_MovableContents; } set { m_MovableContents = value; } }
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            writer.Write((bool)MovableContents);
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
                case 3:
                {
                    m_MovableContents = reader.ReadBool();
                    goto case 2;
                }
				case 2:
				{
