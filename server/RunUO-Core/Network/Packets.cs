...
namespace Server.Network
{
    ...
    {
        // implemented from modern ServUO
        public static readonly Packet TeleportSpeed = SetStatic(new SpeedControl((int)SpeedControlType.TeleportSpeed));
		public static readonly Packet WalkSpeedFast = SetStatic(new SpeedControl((int)SpeedControlType.WalkSpeedFast));
		public static readonly Packet WalkSpeed = SetStatic(new SpeedControl((int)SpeedControlType.WalkSpeed));
		public static readonly Packet MountSpeed = SetStatic(new SpeedControl((int)SpeedControlType.MountSpeed));
		public static readonly Packet Disable = SetStatic(new SpeedControl((int)SpeedControlType.Disable));
    ...
    //New Packet For Showing Mobiles
    public sealed class MobileVisible : Packet
    {
        private static int[] m_DupedLayers = new int[256];
        private static int m_Version;
        ...
        public MobileVisible(Mobile beholder, Mobile beheld)
            : base(0x78)
        {
            m_Beheld = beheld;
            ++m_Version;
