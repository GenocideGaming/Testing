...
namespace Server.Factions
{
	public class JoinStone : BaseSystemController
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( m_Faction == null )
				return;
            if (m_Faction.OwningCommonwealth == null)
                return;
            ...
            if (player.CitizenshipPlayerState == null)
            {
                from.SendMessage("You are not a member of this militia's township, you must become a citizen before you can join the militia.");
                return;
            }
