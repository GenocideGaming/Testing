...
namespace Server.Engines.Craft
{
	public class DefCarpentry : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            AddCraft(typeof(PlantBowl), 1044294, 1029913, 55.0, 65.0, typeof(Log), 1044041, 5, 1044351);
			...
			AddCraft( typeof( ShortMusicStand ),			1044294, 1044313,	78.9, 99.9,		typeof( Log ), 1044041, 15, 1044351 );
			AddCraft( typeof( TallMusicStand ),				1044294, 1044315,	81.5, 101.5,	typeof( Log ), 1044041, 20, 1044351 );
			AddCraft( typeof( Easle ),						1044294, 1044317,	86.8, 101.8,	typeof( Log ), 1044041, 20, 1044351 );
			...
			AddCraft( typeof( LargeTable ),					1044291, 1044308,	84.2, 101.2,	typeof( Log ), 1044041, 27, 1044351 );
			...
			AddCraft( typeof( FancyArmoire ),				1044292, 1044312,	84.2, 101.2,	typeof( Log ), 1044041, 35, 1044351 );
			AddCraft( typeof( Armoire ),					1044292, 1022643,	84.2, 100.2,	typeof( Log ), 1044041, 35, 1044351 );
			...
			// Staves and Shields
			AddCraft( typeof( ShepherdsCrook ), 1044295, 1023713, 78.9, 101.9, typeof( Log ), 1044041, 6, 1044351 );
			AddCraft( typeof( QuarterStaff ), 1044295, 1023721, 73.6, 98.6, typeof( Log ), 1044041, 6, 1044351 );
			AddCraft( typeof( GnarledStaff ), 1044295, 1025112, 78.9, 101.9, typeof( Log ), 1044041, 6, 1044351 );
			AddCraft( typeof( WoodenShield ), 1044295, 1027034, 52.6, 77.6, typeof( Log ), 1044041, 9, 1044351 );
            AddCraft( typeof( Club ), 1044295, 1025043, 65.0, 83.0, typeof( Log ), 1044041, 6, 1044351 );
			...
			index = AddCraft( typeof( Harp ), 1044293, 1023761, 78.9, 100.9, typeof( Log ), 1044041, 35, 1044351 );
			AddSkill( index, SkillName.Musicianship, 45.0, 50.0 );
			...
			// Misc
			index = AddCraft( typeof( SmallBedSouthDeed ), 1044290, 1044321, 90.7, 109.8, typeof( Log ), 1044041, 100, 1044351 );
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 100, 1044287 );
			index = AddCraft(typeof(SmallBedEastDeed), 1044290, 1044322, 90.7, 109.8, typeof(Log), 1044041, 100, 1044351);
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 100, 1044287 );
			index = AddCraft(typeof(LargeBedSouthDeed), 1044290, 1044323, 90.7, 109.8, typeof(Log), 1044041, 150, 1044351);
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 150, 1044287 );
			index = AddCraft(typeof(LargeBedEastDeed), 1044290, 1044324, 90.7, 109.8, typeof(Log), 1044041, 150, 1044351);
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 150, 1044287 );
			...
			index = AddCraft( typeof( PentagramDeed ), 1044290, 1044328, 95.0, 110.0, typeof( Log ), 1044041, 100, 1044351 );
			AddSkill( index, SkillName.Magery, 75.0, 80.0 );
			AddRes( index, typeof( IronIngot ), 1044036, 40, 1044037 );
			index = AddCraft( typeof( AbbatoirDeed ), 1044290, 1044329, 95.0, 110.0, typeof( Log ), 1044041, 100, 1044351 );
			...
			index = AddCraft( typeof( LargeForgeEastDeed ), 1044296, 1044331, 78.9, 97.9, typeof( Log ), 1044041, 5, 1044351 );
			AddSkill( index, SkillName.Blacksmith, 80.0, 85.0 );
			AddRes( index, typeof( IronIngot ), 1044036, 100, 1044037 );
			index = AddCraft( typeof( LargeForgeSouthDeed ), 1044296, 1044332, 78.9, 97.9, typeof( Log ), 1044041, 5, 1044351 );
			AddSkill( index, SkillName.Blacksmith, 80.0, 85.0 );
			AddRes( index, typeof( IronIngot ), 1044036, 100, 1044037 );
			...
			AddSkill( index, SkillName.Tailoring, 65.0, 70.0 );
			AddRes( index, typeof( Cloth ), 1044286, 25, 1044287 );
			index = AddCraft( typeof( LoomEastDeed ), 1044298, 1044343, 84.2, 104.2, typeof( Log ), 1044041, 85, 1044351 );
			AddSkill( index, SkillName.Tailoring, 65.0, 70.0 );
			AddRes( index, typeof( Cloth ), 1044286, 25, 1044287 );
			index = AddCraft( typeof( LoomSouthDeed ), 1044298, 1044344, 84.2, 104.2, typeof( Log ), 1044041, 85, 1044351 );
			AddSkill( index, SkillName.Tailoring, 65.0, 70.0 );
			AddRes( index, typeof( Cloth ), 1044286, 25, 1044287 );
			...
			AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
			AddRes( index, typeof( IronIngot ), 1044036, 125, 1044037 );
			index = AddCraft( typeof( FlourMillEastDeed ), 1044299, 1044347, 94.7, 109.7, typeof( Log ), 1044041, 100, 1044351 );
			AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
			AddRes( index, typeof( IronIngot ), 1044036, 50, 1044037 );
			index = AddCraft( typeof( FlourMillSouthDeed ), 1044299, 1044348, 94.7, 109.7, typeof( Log ), 1044041, 100, 1044351 );
			AddSkill( index, SkillName.Tinkering, 50.0, 55.0 );
			AddRes( index, typeof( IronIngot ), 1044036, 50, 1044037 );
			AddCraft( typeof( WaterTroughEastDeed ), 1044299, 1044349, 94.7, 109.7, typeof( Log ), 1044041, 150, 1044351 );
			AddCraft( typeof( WaterTroughSouthDeed ), 1044299, 1044350, 94.7, 109.7, typeof( Log ), 1044041, 150, 1044351 );

            /******************* BOWCRAFT *********************/
            // Materials
            AddCraft(typeof(Kindling), 1044294, 1023553, 0.0, 00.0, typeof(Log), 1044041, 1, 1044351);

            index = AddCraft(typeof(Shaft), 1044294, 1027124, 0.0, 40.0, typeof(Log), 1044041, 1, 1044351);
            SetUseAllRes(index, true);

            // Ammunition
            index = AddCraft(typeof(Arrow), 1044294, 1023903, 0.0, 40.0, typeof(Shaft), 1044560, 1, 1044561);
            AddRes(index, typeof(Feather), 1044294, 1, 1044563);
            SetUseAllRes(index, true);

            index = AddCraft(typeof(Bolt), 1044294, 1027163, 0.0, 40.0, typeof(Shaft), 1044560, 1, 1044561);
            AddRes(index, typeof(Feather), 1044294, 1, 1044563);
            SetUseAllRes(index, true);

            // Weapons
            AddCraft(typeof(Bow), 1044295, 1025042, 30.0, 70.0, typeof(Log), 1044041, 7, 1044351);
            AddCraft(typeof(Crossbow), 1044295, 1023919, 60.0, 100.0, typeof(Log), 1044041, 7, 1044351);
            AddCraft(typeof(HeavyCrossbow), 1044295, 1025117, 80.0, 105.0, typeof(Log), 1044041, 10, 1044351);
            ...
            AddSubRes2(typeof(ArtifactOfGuarding), 1063506, -100.0, 1063520, 1063521);
            AddSubRes2(typeof(ArtifactOfHardening), 1063507, 70.0, 1063520, 1063521);
            AddSubRes2(typeof(ArtifactOfFortification), 1063508, 80.0, 1063520, 1063521);
            AddSubRes2(typeof(ArtifactOfInvulnerability), 1063509, 90.0, 1063520, 1063521);
