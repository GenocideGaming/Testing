...
namespace Server.Items
{
	public class GuildDeed : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
            ...
            {
                from.SendMessage("You can't place a guildstone as a monster!"); // pseudoseer is possessing a monster
                return;
            }
			...
			public override void OnResponse( Mobile from, string text )
			{
				...
				else
				{
					...
					else
					{
                        ...
                        //DatabaseController.AddGuild(guild);
                        //DatabaseController.UpdateGuildMembers(guild, from, false);
					}
				}
			}
