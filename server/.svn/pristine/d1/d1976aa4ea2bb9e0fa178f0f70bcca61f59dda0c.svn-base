	...
	{ 
		...
		{ 
			...
			{ 
				...
				Add( new GenericBuyInfo( typeof( Gears ), 3, 20, 0x1053, 0 ) );
				Add( new GenericBuyInfo( typeof( Hinge ), 3, 20, 0x1055, 0 ) );

				Add( new GenericBuyInfo( typeof( Sextant ), 13, 20, 0x1057, 0 ) );
				Add( new GenericBuyInfo( typeof( SextantParts ), 5, 20, 0x1059, 0 ) );
				Add( new GenericBuyInfo( typeof( Axle ), 3, 20, 0x105B, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( TinkersTools ), 7, 50, 0x1EBC, 0 ) );
				Add( new GenericBuyInfo( typeof( SewingKit ), 3, 50, 0xF9D, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( Shovel ), 12, 100, 0xF39, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( Pickaxe ), 25, 200, 0xE86, 0 ) );
