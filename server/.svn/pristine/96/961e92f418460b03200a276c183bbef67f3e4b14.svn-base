...
namespace Server
{
	...
	public class Region : IComparable
	{
		...
		{
			if ( map == null )
				return MapFactory.Internal.DefaultRegion;
        ...
        public virtual void OnExit(Mobile m, Region oldRegion)
        {
            this.OnExit(m);
        }
		...
		public virtual void OnCriminalAction( Mobile m, bool message, bool isGuardCallingAction )
		{
			if ( m_Parent != null )
				m_Parent.OnCriminalAction( m, message, isGuardCallingAction );
			else if ( message )
