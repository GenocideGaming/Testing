...
namespace Server.Mobiles
{
	...
	public class EncagedScorpion : BaseCreature
	{
		[Constructable]
		public EncagedScorpion() : base( AIType.AI_Generic, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an encaged scorpion";
			Body = 48;
			BaseSoundID = 397;
        ...
        public EncagedScorpion(Serial serial)
            : base(serial)
		{
		}
