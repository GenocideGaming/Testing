	...
	public class AllianceInfo
	{
		...
		public void CheckLeader()
		{
			if( m_Leader == null || m_Leader.Disbanded )
			{
                ...
                if (m_Leader == null)
                    Disband();
                //else
                    //DatabaseController.UpdateGuildAllianceLeader(this);
			}
		}
		...
		public AllianceInfo( Guild leader, string name, Guild partner )
		{
            ...
            if (!m_Alliances.ContainsKey(m_Name.ToLower()))
            {
                ...
                //DatabaseController.AddNewGuildAlliance(leader, partner, this);
            }
		}
		...
		public void TurnToMember( Guild g )
		{
            ...
            //DatabaseController.UpdateGuildToAlliance(this, g, false);
		}
		...
		public void RemoveGuild( Guild g )
		{
			...
			if( m_Members.Contains( g ) )	//Sanity, just incase someone with a custom script adds a character to BOTH arrays
			{
                ...
                //DatabaseController.UpdateGuildToAlliance(this, g, true);
			}
		...
		public void Disband()
		{
            //DatabaseController.RemoveGuildAlliance(this);
	...
	public class Guild : BaseGuild
	{
		...
		public static void EventSink_GuildGumpRequest( GuildGumpRequestArgs args )
		{
            ...
            if (pm.Guild != null)
                ...
                pm.SendGump(new AllowGuildInviteGump(pm));
		}
		...
		public void CheckExpiredWars()
		{
			for( int i = 0; i < AcceptedWars.Count; i++ )
			{
				...
				if( status != WarStatus.InProgress )
				{
                    ...
                    //DatabaseController.UpdateKillsAndStatus(w);
					...
					if( g != null )
					{
                        ...
                        //DatabaseController.UpdateKillsAndStatus(g.FindActiveWar(this));
		...
		public static void HandleDeath( Mobile victim, Mobile killer )
		{
            ...
            if (killerPM != null && victimPM != null)
            {
                killerPM.GuildKillsThisSession++;
                victimPM.GuildDeathsThisSession++;
            }
		}
		#endregion
		...
		public void Disband()
		{
			...
			foreach ( Mobile m in m_Members )
			{
                ...
                //If Guild Member is Ghost, Validate Its Sight
                if (!m.Alive)
                {
                    m.ValidateGhostVisibility();
                }

                //DatabaseController.UpdateGuildMembers(this, m, true);
			}

			m_Members.Clear();

            //DatabaseController.RemoveGuild(this);
		...
		public void AddMember( Mobile m )
		{
			if ( !m_Members.Contains( m ) )
			{
                ...
                //If New Guild Member is Ghost, Validate Its Sight
                if (!m.Alive)
                {
                    m.ValidateGhostVisibility();
                }
                ...
                //DatabaseController.UpdateGuildMembers(guild, m, false);
			}
		}
		...
		public void RemoveMember( Mobile m, int message )
		{
			if ( m_Members.Contains( m ) )
			{
                ...
                //If Removed Guild Member is Ghost, Validate Its Sight
                if (!m.Alive)
                {
                    m.ValidateGhostVisibility();
                }
                ...
                //DatabaseController.UpdateGuildMembers(guild, m, true);
		...
		public void CalculateGuildmaster()
		{
            ...
            //if(winner != null)
                //DatabaseController.UpdateGuildLeader(this, winner);  
		}
