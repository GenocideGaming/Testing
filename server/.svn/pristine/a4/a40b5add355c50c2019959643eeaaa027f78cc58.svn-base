...
namespace Server.Multis
{
	...
	public abstract class BaseBoat : BaseMulti
	{
		...
		protected static int SlowSpeed = 1;
		protected static int FastSpeed = 3;
		...
		protected static Direction Forward = Direction.North;
		protected static Direction ForwardLeft = Direction.Up;
		protected static Direction ForwardRight = Direction.Right;
		protected static Direction Backward = Direction.South;
		protected static Direction BackwardLeft = Direction.Left;
		protected static Direction BackwardRight = Direction.Down;
		protected static Direction Left = Direction.West;
		protected static Direction Right = Direction.East;
		protected static Direction Port = Left;
		protected static Direction Starboard = Right;
		...
		public virtual bool DoMovement( bool message )
		{
			Direction dir;
			int speed;
