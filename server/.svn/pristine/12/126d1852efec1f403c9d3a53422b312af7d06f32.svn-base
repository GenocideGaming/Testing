	...
	public class Board : Item, ICommodity
	{
		...
		{ 
			get
			{
				switch ( m_Resource )
				{
                    case CraftResource.OakWood: return 1075052;
                    case CraftResource.AshWood: return 1075053;
                    case CraftResource.YewWood: return 1075054;
		...
		{
			Stackable = true;
            Weight = FeatureList.Harvesting.BoardWeight;
			Amount = amount;
