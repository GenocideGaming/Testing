...
{
    public class PlayerRenameGump : Gump
    {
        ...
        public PlayerRenameGump(Mobile from)
            : this()
        {
            caller = from;
        }

        public PlayerRenameGump()
            : base(0, 0)
        {
            this.Closable = true;
            ...
            AddLabel(10, 10, 0, @"The name you have chosen has already been taken.");
            AddLabel(10, 25, 0, @"You must enter a new name before you may continue.");
