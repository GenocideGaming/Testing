...
namespace Server.Misc
{
	public class RazorFeatureControl
	{
		...
		public static readonly TimeSpan HandshakeTimeout = TimeSpan.FromSeconds( 10.0 ); // How long to wait for a handshake response before showing warning and disconnecting1
		...
		{
			DisallowFeature( RazorFeatures.ClosestTargets );
		}
