...
namespace Server.Mobiles
{
	...
	public class GlobalTownCrierEntryList : ITownCrierEntryList
	{
		...
		public static void Initialize()
		{
            ...
            CommandSystem.Register("TownCriersDungeons", AccessLevel.GameMaster, new CommandEventHandler(TownCriersDungeons_Command));
		}
        ...
        public static void TownCriersDungeons_Command(CommandEventArgs e)
        {
            TownCrier.DungeonOpenings = e.ArgString;
        }
	...
	public class TownCrier : Mobile, ITownCrierEntryList
	{
        ...
        public string UpdateDungeonOpenings { get { return DungeonOpenings; } set { DungeonOpenings = value; } }

        public static string DungeonOpenings = "Sorry, but information is still forthcoming!";
		...
		{
            if (m_NewsTimer != null || !e.Mobile.Alive || !InRange(e.Mobile, 12)) { return; }

            if (e.HasKeyword( 0x30 )) // *news*
			{
            ...
            else if (e.Speech.ToLower().Trim().StartsWith("dungeon"))
            {
                PublicOverheadMessage( MessageType.Regular, 0x38, true, "Regarding dungeons of Atria:");
                PublicOverheadMessage(MessageType.Regular, 0x38, true, DungeonOpenings);
            }
		}
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            //version 1
            writer.Write(DungeonOpenings); // not the most efficient, but it'll be fine
		}
		...
		public override void Deserialize( GenericReader reader )
		{
            ...
            if (version >= 1)
            {
                DungeonOpenings = reader.ReadString();
            }
