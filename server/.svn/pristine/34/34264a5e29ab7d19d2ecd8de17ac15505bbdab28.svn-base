	...
	public abstract class BaseExplosionPotion : BasePotion
	{
		...
		public override void Drink( Mobile from )
		{
			...
			if ( m_Timer == null )
			{
                ...
                int explosionDelay = Utility.RandomMinMax(FeatureList.ExploPotions.MinDelay, FeatureList.ExploPotions.MaxDelay);
                m_Timer = Timer.DelayCall(TimeSpan.FromSeconds(0.75), TimeSpan.FromSeconds(1.0), explosionDelay + 1, new TimerStateCallback(Detonate_OnTick), new object[] { from, explosionDelay });
			}
		}
