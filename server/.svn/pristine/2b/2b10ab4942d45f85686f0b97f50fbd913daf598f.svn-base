...
namespace Server.Factions
{
	public class FactionSorceress : BaseFactionGuard
	{
		...
		public FactionSorceress() : base( "the sorceress" )
		{
			...
			AddItem( Immovable( Rehued( new WizardsHat(), 1175 ) ) );
			AddItem( Immovable( Rehued( new Sandals(), 1175 ) ) );
			AddItem( Immovable( Rehued( new LeatherGorget(), 1175 ) ) );
			AddItem( Immovable( Rehued( new LeatherGloves(), 1175 ) ) );
			AddItem( Immovable( Rehued( new LeatherLegs(), 1175 ) ) );
			AddItem( Immovable( Rehued( new Skirt(), 1175 ) ) );
			AddItem( Immovable( Rehued( new FemaleLeatherChest(), 1175 ) ) );
			AddItem( Newbied( Rehued( new QuarterStaff(), 1175 ) ) );
