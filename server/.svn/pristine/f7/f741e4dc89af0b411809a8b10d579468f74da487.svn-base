...
namespace Server.Factions
{
	public class FactionKnight : BaseFactionGuard
	{
		...
		public FactionKnight() : base( "the knight" )
		{
			...
			AddItem( Immovable( Rehued( new ChainChest(), 2406 ) ) );
			AddItem( Immovable( Rehued( new ChainLegs(), 2406 ) ) );
			AddItem( Immovable( Rehued( new ChainCoif(), 2406 ) ) );
			AddItem( Immovable( Rehued( new PlateArms(), 2406 ) ) );
			AddItem( Immovable( Rehued( new PlateGloves(), 2406 ) ) );

			AddItem( Immovable( Rehued( new BodySash(), 1175 ) ) );
			AddItem( Immovable( Rehued( new Kilt(), 1175 ) ) );
