...
namespace Server
{
	public class PoisonImpl : Poison
	{
		...
		public static void Configure()
		{
            ...
            Register(new PoisonImpl("Lesser", 0, 4, 26, 2.500, 3.5, 3.5, 10, 2));
            Register(new PoisonImpl("Regular", 1, 5, 26, 3.125, 3.5, 3.5, 10, 2));
            Register(new PoisonImpl("Greater", 2, 6, 26, 6.250, 3.5, 3.5, 10, 2));
            Register(new PoisonImpl("Deadly", 3, 7, 26, 10.500, 1.0, 4.0, 10, 2));
            Register(new PoisonImpl("Lethal", 4, 9, 26, 20.000, 1.0, 4.0, 10, 2));
		...
		public class PoisonTimer : Timer
		{
			...
			{
                if (m_From is BaseCreature && OrangePetals.UnderEffect( m_Mobile ))
				{
