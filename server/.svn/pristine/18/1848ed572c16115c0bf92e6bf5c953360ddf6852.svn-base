...
{
    public class RunicBlacksmithGump : Gump
    {
        ...
        */
        ...
        public RunicBlacksmithGump(Mobile owner)
            : base(GumpOffsetX, GumpOffsetY)
        {
            owner.CloseGump(typeof(RunicBlacksmithGump));
            m_Owner = owner;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch ((BUTTON_IDS)info.ButtonID)
            {
                ...
                case BUTTON_IDS.RemoveAllPseudoSeers:
                    PseudoSeerStone.Instance._ClearPseudoSeers = true;
