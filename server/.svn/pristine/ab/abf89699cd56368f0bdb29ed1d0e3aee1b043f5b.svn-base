		...
		private static CureLevelInfo[] m_OldLevelInfo = new CureLevelInfo[]
			{
				...
				new CureLevelInfo( Poison.Regular, 0.00 ), //  75% chance to cure regular poison
				new CureLevelInfo( Poison.Greater, 0.00 ), //  50% chance to cure greater poison
				new CureLevelInfo( Poison.Deadly,  0.00 )  //  15% chance to cure deadly poison
			};
