...
namespace Server.Engines.Harvest
{
	public class HarvestDefinition
	{
        ...
        {
            CommandSystem.Register("RefreshResources", AccessLevel.GameMaster, new CommandEventHandler(RefreshResources_Command));
        }
        ...
        public static void RefreshResources_Command(CommandEventArgs e)
        {
            ...
            {
                Point3D point;
                point = new Point3D(int.Parse(args[0]), int.Parse(args[1]), 0);
