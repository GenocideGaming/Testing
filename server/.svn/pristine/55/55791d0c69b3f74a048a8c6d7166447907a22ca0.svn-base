...
namespace Server.Engines.Craft
{
	public class DefAlchemy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			// Poison Potion
			index = AddCraft( typeof( LesserPoisonPotion ), 1044535, 1044548, -5.0, 45.0, typeof( Nightshade ), 1044358, 3, 1044366 );
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
			index = AddCraft( typeof( PoisonPotion ), 1044535, 1044549, 15.0, 65.0, typeof( Nightshade ), 1044358, 3, 1044366 );
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
			index = AddCraft( typeof( GreaterPoisonPotion ), 1044535, 1044550, 55.0, 105.0, typeof( Nightshade ), 1044358, 4, 1044366 );
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
			index = AddCraft( typeof( DeadlyPoisonPotion ), 1044535, 1044551, 85.0, 115.0, typeof( Nightshade ), 1044358, 8, 1044366 );
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
			...
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
			index = AddCraft( typeof( GreaterCurePotion ), 1044536, 1044554, 65.0, 105.0, typeof( Garlic ), 1044355, 6, 1044363 );
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
			...
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
			index = AddCraft( typeof( GreaterExplosionPotion ), 1044537, 1044557, 65.0, 105.0, typeof( SulfurousAsh ), 1044359, 10, 1044367 );
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );

            // Start Preperations
            index = AddCraft(typeof(ArmamentDyeStrippingTub), 1044496, 1063589, 80.0, 80.0, typeof(BaseBeverage), 1046458, 1, 1044253);
            AddRes(index, typeof(OxidizingPowder), 1063590, 1, 1044253);
            ...
            index = AddCraft(typeof(OrcishPaint), 1044496, 1063581, 80.0, 80.0, typeof(SackFlour), 1044468, 1, 1044253);
            AddRes(index, typeof(OrcishHeart), 1063580, 1, 1044253);
            index = AddCraft(typeof(DrowPaint), 1044496, 1063583, 80.0, 80.0, typeof(SackFlour), 1044468, 1, 1044253);
            AddRes(index, typeof(DrowGland), 1063582, 1, 1044253);
            index = AddCraft(typeof(UndeadPaint), 1044496, 1063585, 80.0, 80.0, typeof(SackFlour), 1044468, 1, 1044253);
            AddRes(index, typeof(BoneDust), 1063584, 1, 1044253);
		}
