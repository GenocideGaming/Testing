...
namespace Server.Mobiles
{
    ...
    public class PlayerMobile : Mobile
    {
        ...
        */
        ...
        public int? CriminalTimerSeconds { get; set; } // Seconds until criminal status expires
        public int? MurderDecayHours { get; set; } // Hours until murder count decays
        public int? PvpCooldownSeconds { get; set; } // Seconds for PvP combat cooldown
        public int? BandageTimerSeconds { get; set; } // Seconds for bandage application
